 ...
 * remarks: 勘定科目<br>
 */
@Table(name = "accounts", schema = "bb_account", type = "TABLE", remarks = "勘定科目")
...
public class accounts
	...
	SelectStatement,
	SQLDecorators,
	Query<accounts.Iterator, accounts.Row>,
	RightTable<accounts.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "org_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "組織ID", defaultValue = "null", ordinalPosition = 2, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "seq", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "組織内連番", defaultValue = "null", ordinalPosition = 3, notNull = true)
	public static final String seq = "seq";

	/**
	 * name: code<br>
	 * remarks: 外部アプリケーション指定コード<br>
	 * type: text(2147483647)<br>
	 * not null: true<br>
	 */
	@Column(name = "code", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "外部アプリケーション指定コード", defaultValue = "null", ordinalPosition = 4, notNull = true)
	...
	/**
	 * name: accounts_org_id_fkey<br>
	 * references: orgs<br>
	 * columns: org_id
	 */
	@ForeignKey(name = "accounts_org_id_fkey", references = "bb.orgs", columns = { "org_id" }, refColumns = { "id" })
	public static final String bb$orgs$accounts_org_id_fkey = "accounts_org_id_fkey";

	/**
	 * name: accounts_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "accounts_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$accounts_created_by_fkey = "accounts_created_by_fkey";

	/**
	 * name: accounts_updated_by_fkey<br>
	 * references: users<br>
	 * columns: updated_by
	 */
	@ForeignKey(name = "accounts_updated_by_fkey", references = "bb.users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String bb$users$accounts_updated_by_fkey = "accounts_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * @param value java.util.UUID
		 */
		public void setOrg_id(java.util.UUID value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
		 ...
		 * @return java.util.UUID
		 */
		public java.util.UUID getOrg_id() {
		...
		public void setType(java.lang.String value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("type").getType());
			data$.setValue("type", valueExtractor.extractAsBinder(value));
		}
		...
		public java.lang.String getType() {
			Binder binder = data$.getValue("type");
			return (java.lang.String) binder.getValue();
		}
		 ...
		 * 参照先テーブル名 orgs<br>
		 * 外部キー名 accounts_org_id_fkey<br>
		 * 項目名 org_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.orgs.Row $orgs() {
			return sqlassist.bb.orgs.row(
				data$.getDataObject(bb$orgs$accounts_org_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 accounts_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$accounts_created_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$accounts_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 accounts_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$accounts_updated_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$accounts_updated_by_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), accounts.this);
		}
	 ...
	 */
	public accounts(SelectContext context) {
	 ...
	 * @return this
	 */
	public accounts selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public accounts groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public accounts orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> accounts CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public accounts setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public accounts setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public accounts and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public accounts or(Criteria criteria) {
	 ...
	 */
	@Override
	public accounts accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public accounts resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_account.accounts.id);
			this.org_id = builder$.buildColumn(this, sqlassist.bb_account.accounts.org_id);
			...
			this.tags = builder$.buildColumn(this, sqlassist.bb_account.accounts.tags);
			this.active = builder$.buildColumn(this, sqlassist.bb_account.accounts.active);
			this.created_at = builder$.buildColumn(this, sqlassist.bb_account.accounts.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb_account.accounts.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb_account.accounts.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb_account.accounts.updated_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.orgs.ExtAssist<T, Many<sqlassist.bb_account.accounts.Row, M>> $orgs() {
			return new sqlassist.bb.orgs.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.accounts.bb$orgs$accounts_org_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_account.accounts.Row, M>> $users$accounts_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.accounts.bb$users$accounts_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_account.accounts.Row, M>> $users$accounts_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.accounts.bb$users$accounts_updated_by_fkey);
		}
	}
