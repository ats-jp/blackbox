 ...
 * name: subaccounts_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "subaccounts_tags", schema = "bb_account", type = "TABLE", remarks = "")
public class subaccounts_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<subaccounts_tags.Iterator, subaccounts_tags.Row>,
	RightTable<subaccounts_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "subaccounts_tags";
	...
	/**
	 * name: subaccounts_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "subaccounts_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$subaccounts_tags_tag_id_fkey = "subaccounts_tags_tag_id_fkey";

	/**
	 * name: subaccounts_tags_id_fkey<br>
	 * references: subaccounts<br>
	 * columns: id
	 */
	@ForeignKey(name = "subaccounts_tags_id_fkey", references = "bb_account.subaccounts", columns = { "id" }, refColumns = { "id" })
	public static final String bb_account$subaccounts$subaccounts_tags_id_fkey = "subaccounts_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 subaccounts_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$subaccounts_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 subaccounts<br>
		 * 外部キー名 subaccounts_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb_account.subaccounts.Row $subaccounts() {
			return sqlassist.bb_account.subaccounts.row(
				data$.getDataObject(bb_account$subaccounts$subaccounts_tags_id_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), subaccounts_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				subaccounts_tags.this.getRuntimeId(),
				subaccounts_tags.this);
		}
	 ...
	 */
	public subaccounts_tags(SelectContext context) {
	 ...
	 * @return this
	 */
	public subaccounts_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public subaccounts_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public subaccounts_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public subaccounts_tags SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final subaccounts_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final subaccounts_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> subaccounts_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts_tags ORDER_BY(
	 ...
	 */
	public subaccounts_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public subaccounts_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public subaccounts_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public subaccounts_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public subaccounts_tags accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_account.subaccounts_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb_account.subaccounts_tags.tag_id);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb_account.subaccounts_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.subaccounts_tags.bb$tags$subaccounts_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb_account.subaccounts.ExtAssist<T, Many<sqlassist.bb_account.subaccounts_tags.Row, M>> $subaccounts() {
			return new sqlassist.bb_account.subaccounts.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.subaccounts_tags.bb_account$subaccounts$subaccounts_tags_id_fkey);
		}
	}
