 ...
 * name: group_accounts<br>
 * type: TABLE<br>
 * remarks: グループ別勘定科目<br>
 */
@Table(name = "group_accounts", schema = "bb_account", type = "TABLE", remarks = "グループ別勘定科目")
@PrimaryKey(name = "group_accounts_pkey", columns = { "id" })
public class group_accounts
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<group_accounts.Iterator, group_accounts.Row>,
	RightTable<group_accounts.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "group_accounts";
	...
	/**
	 * name: subaccount_id<br>
	 * remarks: 小勘定科目ID<br>
	 * type: uuid(2147483647)<br>
	 * not null: true<br>
	 */
	@Column(name = "subaccount_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "小勘定科目ID", defaultValue = "null", ordinalPosition = 3, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "created_by", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "作成ユーザー", defaultValue = "null", ordinalPosition = 5, notNull = true)
	public static final String created_by = "created_by";

	/**
	 * name: group_accounts_group_id_fkey<br>
	 * references: groups<br>
	 * columns: group_id
	 */
	@ForeignKey(name = "group_accounts_group_id_fkey", references = "bb.groups", columns = { "group_id" }, refColumns = { "id" })
	public static final String bb$groups$group_accounts_group_id_fkey = "group_accounts_group_id_fkey";

	/**
	 * name: group_accounts_id_fkey<br>
	 * references: units<br>
	 * columns: id
	 */
	@ForeignKey(name = "group_accounts_id_fkey", references = "bb.units", columns = { "id" }, refColumns = { "id" })
	public static final String bb$units$group_accounts_id_fkey = "group_accounts_id_fkey";

	/**
	 * name: group_accounts_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "group_accounts_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$group_accounts_created_by_fkey = "group_accounts_created_by_fkey";

	/**
	 * name: group_accounts_subaccount_id_fkey<br>
	 * references: subaccounts<br>
	 * columns: subaccount_id
	 */
	@ForeignKey(name = "group_accounts_subaccount_id_fkey", references = "bb_account.subaccounts", columns = { "subaccount_id" }, refColumns = { "id" })
	public static final String bb_account$subaccounts$group_accounts_subaccount_id_fkey = "group_accounts_subaccount_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * @param value java.util.UUID
		 */
		public void setSubaccount_id(java.util.UUID value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("subaccount_id").getType());
			data$.setValue("subaccount_id", valueExtractor.extractAsBinder(value));
		}
		 ...
		 * @return java.util.UUID
		 */
		public java.util.UUID getSubaccount_id() {
			Binder binder = data$.getValue("subaccount_id");
			return (java.util.UUID) binder.getValue();
		}
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 group_accounts_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups() {
			return sqlassist.bb.groups.row(
				data$.getDataObject(bb$groups$group_accounts_group_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 units<br>
		 * 外部キー名 group_accounts_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.units.Row $units() {
			return sqlassist.bb.units.row(
				data$.getDataObject(bb$units$group_accounts_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 group_accounts_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$group_accounts_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 subaccounts<br>
		 * 外部キー名 group_accounts_subaccount_id_fkey<br>
		 * 項目名 subaccount_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb_account.subaccounts.Row $subaccounts() {
			return sqlassist.bb_account.subaccounts.row(
				data$.getDataObject(bb_account$subaccounts$group_accounts_subaccount_id_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), group_accounts.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				group_accounts.this.getRuntimeId(),
				group_accounts.this);
		}
	 ...
	 */
	public group_accounts(SelectContext context) {
	 ...
	 * @return this
	 */
	public group_accounts selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public group_accounts groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public group_accounts orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final group_accounts WHERE(
	 ...
	 */
	@SafeVarargs
	public final group_accounts HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, group_accounts> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, group_accounts> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, group_accounts> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, group_accounts> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> group_accounts CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_accounts ORDER_BY(
	 ...
	 */
	public group_accounts setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public group_accounts setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public group_accounts and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public group_accounts or(Criteria criteria) {
	 ...
	 */
	@Override
	public group_accounts accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public group_accounts resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_account.group_accounts.id);
			this.group_id = builder$.buildColumn(this, sqlassist.bb_account.group_accounts.group_id);
			this.subaccount_id = builder$.buildColumn(this, sqlassist.bb_account.group_accounts.subaccount_id);
			this.created_at = builder$.buildColumn(this, sqlassist.bb_account.group_accounts.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb_account.group_accounts.created_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb_account.group_accounts.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.group_accounts.bb$groups$group_accounts_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.units.ExtAssist<T, Many<sqlassist.bb_account.group_accounts.Row, M>> $units() {
			return new sqlassist.bb.units.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.group_accounts.bb$units$group_accounts_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_account.group_accounts.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.group_accounts.bb$users$group_accounts_created_by_fkey);
		}
		 ...
		 * 外部キー名 group_accounts_subaccount_id_fkey<br>
		 * 項目名 subaccount_id
		 * @return subaccounts relationship
		 */
		public sqlassist.bb_account.subaccounts.ExtAssist<T, Many<sqlassist.bb_account.group_accounts.Row, M>> $subaccounts() {
			return new sqlassist.bb_account.subaccounts.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.group_accounts.bb_account$subaccounts$group_accounts_subaccount_id_fkey);
		}
	}
