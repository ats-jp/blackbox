...
/**
 * 自動生成されたテーブル操作クラスです。
 * schema: bb_account<br>
 * name: subaccounts<br>
 * type: TABLE<br>
 * remarks: 小勘定科目<br>
 */
@Table(name = "subaccounts", schema = "bb_account", type = "TABLE", remarks = "小勘定科目")
@PrimaryKey(name = "subaccounts_pkey", columns = { "id" })
public class subaccounts
	...
	SelectStatement,
	SQLDecorators,
	Query<subaccounts.Iterator, subaccounts.Row>,
	RightTable<subaccounts.OnRightAssist> {

	/**
	 * この定数クラスのスキーマ名
	 */
	public static final String SCHEMA = "bb_account";

	/**
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "subaccounts";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "account_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "勘定科目ID", defaultValue = "null", ordinalPosition = 2, notNull = true)
	public static final String account_id = "account_id";

	/**
	 * name: seq_in_account<br>
	 * remarks: 勘定科目内連番<br>
	 * type: int8(19)<br>
	 * not null: true<br>
	 */
	@Column(name = "seq_in_account", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "勘定科目内連番", defaultValue = "null", ordinalPosition = 3, notNull = true)
	public static final String seq_in_account = "seq_in_account";

	/**
	 * name: code<br>
	 * remarks: 外部アプリケーション指定サブコード<br>
	 * type: text(2147483647)<br>
	 * not null: true<br>
	 */
	@Column(name = "code", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "外部アプリケーション指定サブコード", defaultValue = "null", ordinalPosition = 4, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "name", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "名称", defaultValue = "null", ordinalPosition = 5, notNull = true)
	...
	/**
	 * name: subaccounts_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "subaccounts_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$subaccounts_created_by_fkey = "subaccounts_created_by_fkey";

	/**
	 * name: subaccounts_updated_by_fkey<br>
	 * references: users<br>
	 * columns: updated_by
	 */
	@ForeignKey(name = "subaccounts_updated_by_fkey", references = "bb.users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String bb$users$subaccounts_updated_by_fkey = "subaccounts_updated_by_fkey";

	/**
	 * name: subaccounts_account_id_fkey<br>
	 * references: accounts<br>
	 * columns: account_id
	 */
	@ForeignKey(name = "subaccounts_account_id_fkey", references = "bb_account.accounts", columns = { "account_id" }, refColumns = { "id" })
	public static final String bb_account$accounts$subaccounts_account_id_fkey = "subaccounts_account_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * @param value java.util.UUID
		 */
		public void setAccount_id(java.util.UUID value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("account_id").getType());
			data$.setValue("account_id", valueExtractor.extractAsBinder(value));
		}
		 ...
		 * @return java.util.UUID
		 */
		public java.util.UUID getAccount_id() {
			Binder binder = data$.getValue("account_id");
			return (java.util.UUID) binder.getValue();
		}
		 ...
		 */
		public void setSeq_in_account(java.lang.Long value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("seq_in_account").getType());
			data$.setValue("seq_in_account", valueExtractor.extractAsBinder(value));
		}
		 ...
		 */
		public java.lang.Long getSeq_in_account() {
			Binder binder = data$.getValue("seq_in_account");
		 ...
		 * 参照先テーブル名 users<br>
		 * 外部キー名 subaccounts_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$subaccounts_created_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$subaccounts_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 subaccounts_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$subaccounts_updated_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$subaccounts_updated_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 accounts<br>
		 * 外部キー名 subaccounts_account_id_fkey<br>
		 * 項目名 account_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb_account.accounts.Row $accounts() {
			return sqlassist.bb_account.accounts.row(
				data$.getDataObject(bb_account$accounts$subaccounts_account_id_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), subaccounts.this);
		}
	 ...
	 */
	public subaccounts(SelectContext context) {
	 ...
	 * @return this
	 */
	public subaccounts selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public subaccounts groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public subaccounts orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final subaccounts WHERE(
	 ...
	 */
	@SafeVarargs
	public final subaccounts HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, subaccounts> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> subaccounts CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public subaccounts EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public subaccounts setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public subaccounts setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public subaccounts and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public subaccounts or(Criteria criteria) {
	 ...
	 */
	@Override
	public subaccounts accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public subaccounts resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		 ...
		 * 項目名 account_id
		 */
		public final T account_id;

		/**
		 * 項目名 seq_in_account
		 */
		public final T seq_in_account;
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.id);
			this.account_id = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.account_id);
			this.seq_in_account = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.seq_in_account);
			this.code = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.code);
			this.name = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.name);
			this.description = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.description);
			this.revision = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.revision);
			this.props = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.props);
			this.tags = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.tags);
			this.active = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.active);
			this.created_at = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb_account.subaccounts.updated_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_account.subaccounts.Row, M>> $users$subaccounts_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.subaccounts.bb$users$subaccounts_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_account.subaccounts.Row, M>> $users$subaccounts_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.subaccounts.bb$users$subaccounts_updated_by_fkey);
		}
		 ...
		 * 外部キー名 subaccounts_account_id_fkey<br>
		 * 項目名 account_id
		 * @return accounts relationship
		 */
		public sqlassist.bb_account.accounts.ExtAssist<T, Many<sqlassist.bb_account.subaccounts.Row, M>> $accounts() {
			return new sqlassist.bb_account.accounts.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.subaccounts.bb_account$accounts$subaccounts_account_id_fkey);
		}
	}
