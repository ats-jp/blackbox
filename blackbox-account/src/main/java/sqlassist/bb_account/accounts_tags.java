 ...
 * name: accounts_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "accounts_tags", schema = "bb_account", type = "TABLE", remarks = "")
public class accounts_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<accounts_tags.Iterator, accounts_tags.Row>,
	RightTable<accounts_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "accounts_tags";
	...
	/**
	 * name: accounts_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "accounts_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$accounts_tags_tag_id_fkey = "accounts_tags_tag_id_fkey";

	/**
	 * name: accounts_tags_id_fkey<br>
	 * references: accounts<br>
	 * columns: id
	 */
	@ForeignKey(name = "accounts_tags_id_fkey", references = "bb_account.accounts", columns = { "id" }, refColumns = { "id" })
	public static final String bb_account$accounts$accounts_tags_id_fkey = "accounts_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 accounts_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$accounts_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 accounts<br>
		 * 外部キー名 accounts_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb_account.accounts.Row $accounts() {
			return sqlassist.bb_account.accounts.row(
				data$.getDataObject(bb_account$accounts$accounts_tags_id_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), accounts_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				accounts_tags.this.getRuntimeId(),
				accounts_tags.this);
		}
	 ...
	 */
	public accounts_tags(SelectContext context) {
	 ...
	 * @return this
	 */
	public accounts_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public accounts_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public accounts_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final accounts_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final accounts_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, accounts_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> accounts_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public accounts_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public accounts_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public accounts_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public accounts_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public accounts_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public accounts_tags accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public accounts_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_account.accounts_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb_account.accounts_tags.tag_id);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb_account.accounts_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.accounts_tags.bb$tags$accounts_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb_account.accounts.ExtAssist<T, Many<sqlassist.bb_account.accounts_tags.Row, M>> $accounts() {
			return new sqlassist.bb_account.accounts.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_account.accounts_tags.bb_account$accounts$accounts_tags_id_fkey);
		}
	}
