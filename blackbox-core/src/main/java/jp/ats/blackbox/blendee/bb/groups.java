...
public class groups
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.groups.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.orgs.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.groups.Row, M>> $orgs() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.groups.Row, M>> $users$groups_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.groups.Row, M>> $users$groups_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
