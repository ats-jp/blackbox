...
public class statuses
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.statuses.Row, M>> $groups() {
			return new jp.ats.blackbox.blendee.bb.groups.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.statuses.bb$groups$statuses_group_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.statuses.Row, M>> $users$statuses_created_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.statuses.bb$users$statuses_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.statuses.Row, M>> $users$statuses_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.statuses.bb$users$statuses_updated_by_fkey);
		}
