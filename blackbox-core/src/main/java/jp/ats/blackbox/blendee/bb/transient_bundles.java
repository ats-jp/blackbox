...
public class transient_bundles
	...
	RightTable<transient_bundles.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_bundles> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_bundles> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_bundles> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_bundles> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> transient_bundles CROSS_JOIN(RightTable<R> right) {
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transient_transfers.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_bundles.Row, M>> $transient_transfers() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_bundles.Row, M>> $users() {
