...
public class last_closings
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.last_closings.id);
			this.closing_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.last_closings.closing_id);
			this.closed_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.last_closings.closed_at);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.closings.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.last_closings.Row, M>> $closings() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.last_closings.Row, M>> $groups() {
