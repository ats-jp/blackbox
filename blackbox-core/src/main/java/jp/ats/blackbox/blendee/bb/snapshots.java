...
public class snapshots
	...
	RightTable<snapshots.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, snapshots> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, snapshots> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, snapshots> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, snapshots> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> snapshots CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public snapshots groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public snapshots orderBy(OrderByClause clause) {
	...
	public static class Rel<T, M> implements TableFacadeRelationship {
		...
		public Rel(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.snapshots.id);
			this.total = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.snapshots.total);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.snapshots.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.snapshots.updated_by);
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.nodes.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.snapshots.Row, M>> $nodes() {
			return new jp.ats.blackbox.blendee.bb.nodes.ExtRel<>(
				builder$,
				this,
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.snapshots.Row, M>> $users() {
