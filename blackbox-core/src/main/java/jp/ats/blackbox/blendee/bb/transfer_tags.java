...
public class transfer_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.transfer_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transfer_tags.transfer_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transfer_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transfer_tags.Row, M>> $tags() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transfers.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transfer_tags.Row, M>> $transfers() {
