 ...
 * Blackboxを使用する組織<br>
 */
@Table(name = "orgs", schema = "bb", type = "TABLE", remarks = "組織\nBlackboxを使用する組織")
...
public class orgs
	...
	SelectStatement,
	SQLDecorators,
	Query<orgs.Iterator, orgs.Row>,
	RightTable<orgs.OnRightAssist> {
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), orgs.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, orgs.this.getRuntimeId(), orgs.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static orgs of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new orgs(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public orgs(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private orgs(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public orgs selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public orgs groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public orgs orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, orgs> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, orgs> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, orgs> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, orgs> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public orgs UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public orgs UNION_ALL(SelectStatement select) {
	 ...
	 */
	public orgs setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public orgs setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public orgs and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public orgs or(Criteria criteria) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.id);
			this.name = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.name);
			this.revision = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.revision);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.extension);
			this.active = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.active);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.orgs.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.orgs.Row, M>> $users$orgs_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.orgs.Row, M>> $users$orgs_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
