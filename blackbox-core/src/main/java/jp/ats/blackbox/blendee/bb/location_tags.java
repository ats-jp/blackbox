...
public class location_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.location_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.location_tags.location_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.location_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.locations.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.location_tags.Row, M>> $locations() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.location_tags.Row, M>> $tags() {
