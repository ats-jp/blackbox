...
public class owner_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.owner_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.owner_tags.owner_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.owner_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.owners.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.owner_tags.Row, M>> $owners() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.owner_tags.Row, M>> $tags() {
