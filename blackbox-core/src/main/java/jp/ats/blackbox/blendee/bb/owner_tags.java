...
public class owner_tags
	...
	RightTable<owner_tags.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, owner_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, owner_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, owner_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, owner_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> owner_tags CROSS_JOIN(RightTable<R> right) {
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.owners.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.owner_tags.Row, M>> $owners() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.owner_tags.Row, M>> $tags() {
