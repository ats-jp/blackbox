...
public class item_tags
	...
	RightTable<item_tags.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, item_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, item_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, item_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, item_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> item_tags CROSS_JOIN(RightTable<R> right) {
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.items.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.item_tags.Row, M>> $items() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.item_tags.Row, M>> $tags() {
