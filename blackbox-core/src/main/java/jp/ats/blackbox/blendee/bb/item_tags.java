...
public class item_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.item_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.item_tags.item_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.item_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.items.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.item_tags.Row, M>> $items() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.item_tags.Row, M>> $tags() {
