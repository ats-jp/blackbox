...
public class status_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.status_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.status_tags.status_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.status_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.statuses.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.status_tags.Row, M>> $statuses() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.status_tags.Row, M>> $tags() {
