 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: locking_groups<br>
 * type: TABLE<br>
 * remarks: ロック中グループ<br>
 */
@Table(name = "locking_groups", schema = "bb", type = "TABLE", remarks = "ロック中グループ")
@PrimaryKey(name = "locking_groups_pkey", columns = { "id" })
public class locking_groups
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<locking_groups.Iterator, locking_groups.Row>,
	RightTable<locking_groups.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "locking_groups";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		...
		public void setLocked_at(java.sql.Timestamp value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("locked_at").getType());
			data$.setValue("locked_at", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		...
		public java.sql.Timestamp getLocked_at() {
			Binder binder = data$.getValue("locked_at");
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 locking_groups_id_fkey<br>
		 * 項目名 id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 locking_groups_user_id_fkey<br>
		 * 項目名 user_id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), locking_groups.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, locking_groups.this.getRuntimeId(), locking_groups.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static locking_groups of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new locking_groups(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public locking_groups() {}
	 ...
	 */
	public locking_groups(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private locking_groups(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public locking_groups selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public locking_groups groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public locking_groups orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locking_groups SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locking_groups SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locking_groups GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final locking_groups WHERE(
	 ...
	 */
	@SafeVarargs
	public final locking_groups HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locking_groups> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locking_groups> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locking_groups> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locking_groups> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> locking_groups CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locking_groups UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locking_groups UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locking_groups ORDER_BY(
	 ...
	 */
	public locking_groups setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public locking_groups setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public locking_groups and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public locking_groups or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public locking_groups resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locking_groups.id);
			this.user_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locking_groups.user_id);
			this.locked_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locking_groups.locked_at);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.locking_groups.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.locking_groups.Row, M>> $users() {
