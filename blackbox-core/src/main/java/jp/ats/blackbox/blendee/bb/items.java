 ...
 * 在庫管理する対象となる「もの」<br>
 */
@Table(name = "items", schema = "bb", type = "TABLE", remarks = "アイテム\n在庫管理する対象となる「もの」")
...
public class items
	...
	SelectStatement,
	SQLDecorators,
	Query<items.Iterator, items.Row>,
	RightTable<items.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "nextval('bb.items_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	...
	/**
	 * name: items_group_id_fkey<br>
	 * reference: groups<br>
	 * columns: group_id
	 */
	@ForeignKey(name = "items_group_id_fkey", references = "groups", columns = { "group_id" }, refColumns = { "id" })
	public static final String groups$items_group_id_fkey = "items_group_id_fkey";

	/**
	 * name: items_created_by_fkey<br>
	 * reference: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "items_created_by_fkey", references = "users", columns = { "created_by" }, refColumns = { "id" })
	public static final String users$items_created_by_fkey = "items_created_by_fkey";

	/**
	 * name: items_updated_by_fkey<br>
	 * reference: users<br>
	 * columns: updated_by
	 */
	@ForeignKey(name = "items_updated_by_fkey", references = "users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String users$items_updated_by_fkey = "items_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 items_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.groups.Row $groups() {
			return jp.ats.blackbox.blendee.bb.groups.row(
				data$.getDataObject(groups$items_group_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 items_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$items_created_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$items_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 items_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$items_updated_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$items_updated_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), items.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, items.this.getRuntimeId(), items.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static items of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new items(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public items(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private items(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public items selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public items groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public items orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, items> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, items> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, items> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, items> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> items CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public items UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public items UNION_ALL(SelectStatement select) {
	 ...
	 */
	public items setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public items setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public items and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public items or(Criteria criteria) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.id);
			this.group_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.group_id);
			this.name = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.name);
			this.revision = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.revision);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.extension);
			this.tags = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.tags);
			this.active = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.active);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.items.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.items.Row, M>> $groups() {
			return new jp.ats.blackbox.blendee.bb.groups.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.items.groups$items_group_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.items.Row, M>> $users$items_created_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.items.users$items_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.items.Row, M>> $users$items_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.items.users$items_updated_by_fkey);
		}
