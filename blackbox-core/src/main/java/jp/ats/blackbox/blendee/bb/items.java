...
public class items
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, items> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, items> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, items> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, items> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> items CROSS_JOIN(RightTable<R> right) {
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.items.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.items.Row, M>> $users$items_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.items.Row, M>> $users$items_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtRel<>(
				builder$,
				this,
