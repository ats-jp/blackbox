...
public class transient_nodes
	...
	RightTable<transient_nodes.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_nodes> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_nodes> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_nodes> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_nodes> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> transient_nodes CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public transient_nodes groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_nodes orderBy(OrderByClause clause) {
	...
	public static class Rel<T, M> implements TableFacadeRelationship {
		...
		private final transient_nodes table$;
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.stocks.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $stocks() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transient_bundles.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $transient_bundles() {
			return new jp.ats.blackbox.blendee.bb.transient_bundles.ExtRel<>(
				builder$,
				this,
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $users$transient_nodes_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $users$transient_nodes_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtRel<>(
				builder$,
				this,
