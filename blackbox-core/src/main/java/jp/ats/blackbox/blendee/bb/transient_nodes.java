...
public class transient_nodes
	...
	SelectStatement,
	SQLDecorators,
	Query<transient_nodes.Iterator, transient_nodes.Row>,
	RightTable<transient_nodes.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_nodes";
	 ...
	 * columns: stock_id
	 */
	@ForeignKey(name = "transient_nodes_stock_id_fkey", references = "stocks", columns = { "stock_id" }, refColumns = { "id" })
	public static final String stocks$transient_nodes_stock_id_fkey = "transient_nodes_stock_id_fkey";
	 ...
	 */
	@ForeignKey(name = "transient_nodes_transient_bundle_id_fkey", references = "transient_bundles", columns = { "transient_bundle_id" }, refColumns = { "id" })
	public static final String transient_bundles$transient_nodes_transient_bundle_id_fkey = "transient_nodes_transient_bundle_id_fkey";
	 ...
	 * columns: created_by
	 */
	@ForeignKey(name = "transient_nodes_created_by_fkey", references = "users", columns = { "created_by" }, refColumns = { "id" })
	public static final String users$transient_nodes_created_by_fkey = "transient_nodes_created_by_fkey";
	 ...
	 * columns: updated_by
	 */
	@ForeignKey(name = "transient_nodes_updated_by_fkey", references = "users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String users$transient_nodes_updated_by_fkey = "transient_nodes_updated_by_fkey";
		...
		* not null: true<br>
		...
		public jp.ats.blackbox.blendee.bb.stocks.Row $stocks() {
			return jp.ats.blackbox.blendee.bb.stocks.row(
				data$.getDataObject(stocks$transient_nodes_stock_id_fkey));
		}
		 ...
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.transient_bundles.Row $transient_bundles() {
			return jp.ats.blackbox.blendee.bb.transient_bundles.row(
				data$.getDataObject(transient_bundles$transient_nodes_transient_bundle_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_nodes_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$transient_nodes_created_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$transient_nodes_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_nodes_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$transient_nodes_updated_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$transient_nodes_updated_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_nodes.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transient_nodes.this.getRuntimeId(), transient_nodes.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_nodes of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_nodes(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_nodes() {}
	 ...
	 */
	public transient_nodes(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_nodes(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_nodes selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_nodes groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_nodes orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_nodes WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_nodes HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_nodes> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_nodes> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_nodes> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_nodes> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes ORDER_BY(
	 ...
	 */
	public transient_nodes setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_nodes setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_nodes and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_nodes or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_nodes resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.id);
			this.transient_bundle_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.transient_bundle_id);
			this.stock_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.stock_id);
			this.in_out = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.in_out);
			this.quantity = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.quantity);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.extension);
			this.revision = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.revision);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.stocks.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $stocks() {
			return new jp.ats.blackbox.blendee.bb.stocks.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.stocks$transient_nodes_stock_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transient_bundles.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $transient_bundles() {
			return new jp.ats.blackbox.blendee.bb.transient_bundles.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.transient_bundles$transient_nodes_transient_bundle_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $users$transient_nodes_created_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.users$transient_nodes_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_nodes.Row, M>> $users$transient_nodes_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_nodes.users$transient_nodes_updated_by_fkey);
		}
