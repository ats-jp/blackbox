...
public class relationships
	...
	RightTable<relationships.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, relationships> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, relationships> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, relationships> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, relationships> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> relationships CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public relationships groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public relationships orderBy(OrderByClause clause) {
	...
	public static class Rel<T, M> implements TableFacadeRelationship {
		...
		private final relationships table$;
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.relationships.Row, M>> $groups$relationships_child_id_fkey() {
		 ...
		 * @return groups relationship
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.relationships.Row, M>> $groups$relationships_parent_id_fkey() {
			return new jp.ats.blackbox.blendee.bb.groups.ExtRel<>(
				builder$,
				this,
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.relationships.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.relationships.Row, M>> $relationships() {
			return new jp.ats.blackbox.blendee.bb.relationships.ExtRel<>(
				builder$,
				this,
