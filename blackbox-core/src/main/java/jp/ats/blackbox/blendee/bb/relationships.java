...
public class relationships
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.relationships.id);
			this.parent_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.relationships.parent_id);
			this.child_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.relationships.child_id);
			this.cascade_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.relationships.cascade_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.relationships.Row, M>> $groups$relationships_child_id_fkey() {
		 ...
		 * @return groups relationship
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.relationships.Row, M>> $groups$relationships_parent_id_fkey() {
			return new jp.ats.blackbox.blendee.bb.groups.ExtAssist<>(
				builder$,
				this,
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.relationships.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.relationships.Row, M>> $relationships() {
