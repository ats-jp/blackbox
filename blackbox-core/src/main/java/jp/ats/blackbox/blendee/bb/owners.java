...
public class owners
	 ...
	 * columns: group_id
	 */
	@ForeignKey(name = "owners_group_id_fkey", references = "groups", columns = { "group_id" }, refColumns = { "id" })
	public static final String groups$owners_group_id_fkey = "owners_group_id_fkey";
	 ...
	 * columns: created_by
	 */
	@ForeignKey(name = "owners_created_by_fkey", references = "users", columns = { "created_by" }, refColumns = { "id" })
	public static final String users$owners_created_by_fkey = "owners_created_by_fkey";
	 ...
	 * columns: updated_by
	 */
	@ForeignKey(name = "owners_updated_by_fkey", references = "users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String users$owners_updated_by_fkey = "owners_updated_by_fkey";
		...
		* not null: true<br>
		...
		public jp.ats.blackbox.blendee.bb.groups.Row $groups() {
			return jp.ats.blackbox.blendee.bb.groups.row(
				data$.getDataObject(groups$owners_group_id_fkey));
		}
		 ...
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$owners_created_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$owners_created_by_fkey));
		}
		 ...
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$owners_updated_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$owners_updated_by_fkey));
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.owners.Row, M>> $groups() {
			return new jp.ats.blackbox.blendee.bb.groups.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.owners.groups$owners_group_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.owners.Row, M>> $users$owners_created_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.owners.users$owners_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.owners.Row, M>> $users$owners_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.owners.users$owners_updated_by_fkey);
		}
