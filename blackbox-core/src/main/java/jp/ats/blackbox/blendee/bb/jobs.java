 ...
 * name: jobs<br>
 * type: TABLE<br>
 * remarks: 現在在庫数量反映ジョブ<br>
 */
@Table(name = "jobs", schema = "bb", type = "TABLE", remarks = "現在在庫数量反映ジョブ")
@PrimaryKey(name = "jobs_pkey", columns = { "id" })
public class jobs
	...
	SelectStatement,
	SQLDecorators,
	Query<jobs.Iterator, jobs.Row>,
	RightTable<jobs.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID\ntransfers.transfers_idに従属", defaultValue = "nextval('bb.jobs_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "completed", type = -7, typeName = "bool", size = 1, hasDecimalDigits = true, decimalDigits = 0, remarks = "実施済フラグ", defaultValue = "false", ordinalPosition = 2, notNull = true)
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), jobs.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, jobs.this.getRuntimeId(), jobs.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static jobs of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new jobs(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	...
	private jobs(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public jobs selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public jobs groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public jobs orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, jobs> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, jobs> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, jobs> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, jobs> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public jobs UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public jobs UNION_ALL(SelectStatement select) {
	 ...
	 */
	public jobs setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public jobs setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public jobs and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public jobs or(Criteria criteria) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.id);
			this.completed = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.completed);
			this.trigger_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.trigger_id);
			this.parameter = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.parameter);
			this.revision = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.revision);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.jobs.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transfers.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $transfers() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.triggers.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $triggers() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $users$jobs_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $users$jobs_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
