...
public class jobs
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, jobs> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, jobs> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, jobs> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, jobs> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> jobs CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public jobs groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public jobs orderBy(OrderByClause clause) {
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transfers.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $transfers() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.triggers.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $triggers() {
			return new jp.ats.blackbox.blendee.bb.triggers.ExtRel<>(
				builder$,
				this,
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $users$jobs_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.jobs.Row, M>> $users$jobs_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtRel<>(
				builder$,
				this,
