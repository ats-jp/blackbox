...
public class triggers
	...
	RightTable<triggers.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, triggers> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, triggers> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, triggers> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, triggers> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> triggers CROSS_JOIN(RightTable<R> right) {
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.triggers.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.triggers.Row, M>> $users() {
