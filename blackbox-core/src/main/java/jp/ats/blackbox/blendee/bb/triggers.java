 ...
 * remarks: 追加処理トリガ<br>
 */
@Table(name = "triggers", schema = "bb", type = "TABLE", remarks = "追加処理トリガ")
@PrimaryKey(name = "triggers_pkey", columns = { "id" })
public class triggers
	...
	SelectStatement,
	SQLDecorators,
	Query<triggers.Iterator, triggers.Row>,
	RightTable<triggers.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "nextval('bb.triggers_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "fqcn", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "実施FQCN", defaultValue = "null", ordinalPosition = 3, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "name", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "処理名", defaultValue = "null", ordinalPosition = 4, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 */
		public void setFqcn(java.lang.String value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("fqcn").getType());
			data$.setValue("fqcn", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		...
		public java.lang.String getFqcn() {
			Binder binder = data$.getValue("fqcn");
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 triggers_group_id_fkey<br>
		 * 項目名 group_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 triggers_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), triggers.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, triggers.this.getRuntimeId(), triggers.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static triggers of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new triggers(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public triggers(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private triggers(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public triggers selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public triggers groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public triggers orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public triggers SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, triggers> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, triggers> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, triggers> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, triggers> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> triggers CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public triggers UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public triggers UNION_ALL(SelectStatement select) {
	 ...
	 */
	public triggers setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public triggers setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public triggers and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public triggers or(Criteria criteria) {
	 ...
	 */
	@Override
	public triggers apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public triggers resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.triggers.id);
			this.group_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.triggers.group_id);
			this.fqcn = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.triggers.fqcn);
			this.name = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.triggers.name);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.triggers.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.triggers.created_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.triggers.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.triggers.Row, M>> $users() {
