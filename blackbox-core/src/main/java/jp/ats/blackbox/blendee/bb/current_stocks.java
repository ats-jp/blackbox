 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: current_stocks<br>
 * type: TABLE<br>
 * remarks: 現在在庫<br>
 * 在庫の現在数を保持<br>
 */
@Table(name = "current_stocks", schema = "bb", type = "TABLE", remarks = "現在在庫\n在庫の現在数を保持")
@PrimaryKey(name = "current_stocks_pkey", columns = { "id" })
public class current_stocks
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<current_stocks.Iterator, current_stocks.Row>,
	RightTable<current_stocks.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "current_stocks";
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), current_stocks.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static current_stocks of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new current_stocks(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public current_stocks() {}
	 ...
	 */
	public current_stocks(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private current_stocks(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public current_stocks selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public current_stocks groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public current_stocks orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final current_stocks WHERE(
	 ...
	 */
	@SafeVarargs
	public final current_stocks HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_stocks> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_stocks> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_stocks> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_stocks> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> current_stocks CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks ORDER_BY(
	 ...
	 */
	public current_stocks setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public current_stocks setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public current_stocks and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public current_stocks or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public current_stocks resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.current_stocks.id);
			this.total = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.current_stocks.total);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.current_stocks.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.current_stocks.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.stocks.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.current_stocks.Row, M>> $stocks() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.current_stocks.Row, M>> $users() {
