...
public class transient_transfer_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.transient_transfer_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_transfer_tags.transient_transfer_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_transfer_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_transfer_tags.Row, M>> $tags() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transient_transfers.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_transfer_tags.Row, M>> $transient_transfers() {
