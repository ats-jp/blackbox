...
public class transient_tags
	...
	RightTable<transient_tags.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> transient_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public transient_tags groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_tags orderBy(OrderByClause clause) {
	...
	public static class Rel<T, M> implements TableFacadeRelationship {
		...
		private final transient_tags table$;
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_tags.Row, M>> $tags() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transients.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_tags.Row, M>> $transients() {
