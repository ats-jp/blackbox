 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transient_tags", schema = "bb", type = "TABLE", remarks = "")
public class transient_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transient_tags.Iterator, transient_tags.Row>,
	RightTable<transient_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "transient_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	 ...
	 * columns: tag_id
	 */
	@ForeignKey(name = "transient_tags_tag_id_fkey", references = "tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String tags$transient_tags_tag_id_fkey = "transient_tags_tag_id_fkey";
	 ...
	 */
	@ForeignKey(name = "transient_tags_transient_id_fkey", references = "transients", columns = { "transient_id" }, refColumns = { "id" })
	public static final String transients$transient_tags_transient_id_fkey = "transient_tags_transient_id_fkey";
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transient_tags.this.getRuntimeId(), transient_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_tags() {}
	 ...
	 */
	public transient_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transient_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_tags ORDER_BY(
	 ...
	 */
	public transient_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public transient_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.transient_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_tags.transient_id);
			this.tag_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.tags.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_tags.Row, M>> $tags() {
			return new jp.ats.blackbox.blendee.bb.tags.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_tags.tags$transient_tags_tag_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transients.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_tags.Row, M>> $transients() {
			return new jp.ats.blackbox.blendee.bb.transients.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_tags.transients$transient_tags_transient_id_fkey);
		}
