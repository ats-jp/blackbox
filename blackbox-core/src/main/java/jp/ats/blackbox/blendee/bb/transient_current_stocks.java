...
public class transient_current_stocks
	...
	RightTable<transient_current_stocks.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_current_stocks> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_current_stocks> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_current_stocks> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, transient_current_stocks> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> transient_current_stocks CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public transient_current_stocks groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_current_stocks orderBy(OrderByClause clause) {
	...
	public static class Rel<T, M> implements TableFacadeRelationship {
		...
		private final transient_current_stocks table$;
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.stocks.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $stocks() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transients.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $transients() {
			return new jp.ats.blackbox.blendee.bb.transients.ExtRel<>(
				builder$,
				this,
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $users$transient_current_stocks_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $users$transient_current_stocks_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtRel<>(
				builder$,
				this,
