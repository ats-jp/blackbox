 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_current_stocks<br>
 * type: TABLE<br>
 * remarks: 一時作業現在在庫<br>
 */
@Table(name = "transient_current_stocks", schema = "bb", type = "TABLE", remarks = "一時作業現在在庫")
@PrimaryKey(name = "transient_current_stocks_pkey", columns = { "id" })
public class transient_current_stocks
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transient_current_stocks.Iterator, transient_current_stocks.Row>,
	RightTable<transient_current_stocks.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_current_stocks";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "created_at", type = 93, typeName = "timestamptz", size = 35, hasDecimalDigits = true, decimalDigits = 6, remarks = "作成時刻", defaultValue = "now()", ordinalPosition = 4, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "created_by", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "作成ユーザー", defaultValue = "null", ordinalPosition = 5, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "updated_by", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "更新ユーザー", defaultValue = "null", ordinalPosition = 7, notNull = true)
	 ...
	 * columns: id
	 */
	@ForeignKey(name = "transient_current_stocks_id_fkey", references = "stocks", columns = { "id" }, refColumns = { "id" })
	public static final String stocks$transient_current_stocks_id_fkey = "transient_current_stocks_id_fkey";
	 ...
	 */
	@ForeignKey(name = "transient_current_stocks_transient_id_fkey", references = "transients", columns = { "transient_id" }, refColumns = { "id" })
	public static final String transients$transient_current_stocks_transient_id_fkey = "transient_current_stocks_transient_id_fkey";
	 ...
	 * columns: created_by
	 */
	@ForeignKey(name = "transient_current_stocks_created_by_fkey", references = "users", columns = { "created_by" }, refColumns = { "id" })
	public static final String users$transient_current_stocks_created_by_fkey = "transient_current_stocks_created_by_fkey";
	 ...
	 * columns: updated_by
	 */
	@ForeignKey(name = "transient_current_stocks_updated_by_fkey", references = "users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String users$transient_current_stocks_updated_by_fkey = "transient_current_stocks_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 stocks<br>
		 * 外部キー名 transient_current_stocks_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.stocks.Row $stocks() {
			return jp.ats.blackbox.blendee.bb.stocks.row(
				data$.getDataObject(stocks$transient_current_stocks_id_fkey));
		}
		...
		public jp.ats.blackbox.blendee.bb.transients.Row $transients() {
			return jp.ats.blackbox.blendee.bb.transients.row(
				data$.getDataObject(transients$transient_current_stocks_transient_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_current_stocks_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$transient_current_stocks_created_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$transient_current_stocks_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_current_stocks_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$transient_current_stocks_updated_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$transient_current_stocks_updated_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_current_stocks.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transient_current_stocks.this.getRuntimeId(), transient_current_stocks.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_current_stocks of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_current_stocks(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_current_stocks() {}
	 ...
	 */
	public transient_current_stocks(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_current_stocks(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_current_stocks selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_current_stocks groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_current_stocks orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public transient_current_stocks SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_current_stocks WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_current_stocks HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_current_stocks> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_current_stocks> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_current_stocks> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_current_stocks> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transient_current_stocks CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks ORDER_BY(
	 ...
	 */
	public transient_current_stocks setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_current_stocks setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_current_stocks and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_current_stocks or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks resetDecorators() {
		decorators$.clear();
		return this;
	}
	 ...
	 * @return このインスタンス
	 */
	public transient_current_stocks reset() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		final transient_current_stocks table$;
		...
		private Assist(
			transient_current_stocks table$,
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.id);
			this.transient_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.transient_id);
			this.total = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.total);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.stocks.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $stocks() {
			return new jp.ats.blackbox.blendee.bb.stocks.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.stocks$transient_current_stocks_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transients.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $transients() {
			return new jp.ats.blackbox.blendee.bb.transients.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.transients$transient_current_stocks_transient_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $users$transient_current_stocks_created_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.users$transient_current_stocks_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.transient_current_stocks.Row, M>> $users$transient_current_stocks_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.transient_current_stocks.users$transient_current_stocks_updated_by_fkey);
		}
