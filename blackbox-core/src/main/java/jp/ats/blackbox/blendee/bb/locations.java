...
public class locations
	...
	RightTable<locations.OnRightRel> {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, locations> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, locations> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, locations> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightRelationship<?>> OnClause<OnLeftRel, R, locations> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightRelationship<?>> locations CROSS_JOIN(RightTable<R> right) {
	 ...
	 */
	public locations groupBy(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public locations orderBy(OrderByClause clause) {
	...
	public static class Rel<T, M> implements TableFacadeRelationship {
		...
		public Rel(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.id);
			this.group_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.group_id);
			this.name = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.name);
			this.revision = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.revision);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.extension);
			this.tags = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.tags);
			this.active = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.active);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.locations.updated_by);
	...
	public static class ExtRel<T, M> extends Rel<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.locations.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.locations.Row, M>> $users$locations_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtRel<T, Many<jp.ats.blackbox.blendee.bb.locations.Row, M>> $users$locations_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtRel<>(
				builder$,
				this,
