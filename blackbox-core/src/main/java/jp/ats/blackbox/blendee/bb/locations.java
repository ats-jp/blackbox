...
public class locations
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.locations.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.locations.Row, M>> $users$locations_created_by_fkey() {
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.locations.Row, M>> $users$locations_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
