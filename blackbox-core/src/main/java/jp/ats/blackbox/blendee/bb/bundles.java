...
public class bundles
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.bundles.id);
			this.transfer_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.bundles.transfer_id);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.bundles.extension);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.transfers.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.bundles.Row, M>> $transfers() {
