 ...
 * Blackboxの操作者<br>
 */
@Table(name = "users", schema = "bb", type = "TABLE", remarks = "ユーザー\nBlackboxの操作者")
...
public class users
	...
	SelectStatement,
	SQLDecorators,
	Query<users.Iterator, users.Row>,
	RightTable<users.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "nextval('bb.users_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	 ...
	 * columns: group_id
	 */
	@ForeignKey(name = "users_group_id_fkey", references = "groups", columns = { "group_id" }, refColumns = { "id" })
	public static final String groups$users_group_id_fkey = "users_group_id_fkey";
	 ...
	 * columns: created_by
	 */
	@ForeignKey(name = "users_created_by_fkey", references = "users", columns = { "created_by" }, refColumns = { "id" })
	public static final String users$users_created_by_fkey = "users_created_by_fkey";
	 ...
	 * columns: updated_by
	 */
	@ForeignKey(name = "users_updated_by_fkey", references = "users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String users$users_updated_by_fkey = "users_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 users_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.groups.Row $groups() {
			return jp.ats.blackbox.blendee.bb.groups.row(
				data$.getDataObject(groups$users_group_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 users_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$users_created_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$users_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 users_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public jp.ats.blackbox.blendee.bb.users.Row $users$users_updated_by_fkey() {
			return jp.ats.blackbox.blendee.bb.users.row(
				data$.getDataObject(users$users_updated_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), users.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, users.this.getRuntimeId(), users.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static users of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new users(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public users(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private users(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public users selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public users groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public users orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, users> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, users> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, users> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, users> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> users CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public users UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public users UNION_ALL(SelectStatement select) {
	 ...
	 */
	public users setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public users setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public users and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public users or(Criteria criteria) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.id);
			this.group_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.group_id);
			this.name = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.name);
			this.role = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.role);
			this.revision = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.revision);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.extension);
			this.tags = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.tags);
			this.active = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.active);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.users.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.users.Row, M>> $groups() {
			return new jp.ats.blackbox.blendee.bb.groups.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.users.groups$users_group_id_fkey);
		}
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.users.Row, M>> $users$users_created_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.users.users$users_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.users.Row, M>> $users$users_updated_by_fkey() {
			return new jp.ats.blackbox.blendee.bb.users.ExtAssist<>(
				builder$,
				this,
				jp.ats.blackbox.blendee.bb.users.users$users_updated_by_fkey);
		}
