 ...
 * remarks: 締め<br>
 */
@Table(name = "closings", schema = "bb", type = "TABLE", remarks = "締め")
@PrimaryKey(name = "closings_pkey", columns = { "id" })
public class closings
	...
	SelectStatement,
	SQLDecorators,
	Query<closings.Iterator, closings.Row>,
	RightTable<closings.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "closings";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "nextval('bb.closings_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	...
	/**
	 * name: closings_group_id_fkey<br>
	 * reference: groups<br>
	 * columns: group_id
	 */
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 closings_group_id_fkey<br>
		 * 項目名 group_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 closings_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), closings.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, closings.this.getRuntimeId(), closings.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static closings of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new closings(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public closings(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private closings(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public closings selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public closings groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public closings orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closings SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closings> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closings> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closings> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closings> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> closings CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closings UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closings UNION_ALL(SelectStatement select) {
	 ...
	 */
	public closings setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public closings setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public closings and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public closings or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public closings resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.closings.id);
			this.group_id = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.closings.group_id);
			this.closed_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.closings.closed_at);
			this.extension = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.closings.extension);
			this.created_at = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.closings.created_at);
			this.created_by = builder$.buildColumn(
				this,
				jp.ats.blackbox.blendee.bb.closings.created_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.groups.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.closings.Row, M>> $groups() {
		 ...
		 */
		public jp.ats.blackbox.blendee.bb.users.ExtAssist<T, Many<jp.ats.blackbox.blendee.bb.closings.Row, M>> $users() {
