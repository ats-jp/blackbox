 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transfer_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transfer_tags", schema = "bb", type = "TABLE", remarks = "")
public class transfer_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transfer_tags.Iterator, transfer_tags.Row>,
	RightTable<transfer_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transfer_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "transfer_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	/**
	 * name: transfer_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 */
		public void setTransfer_id(java.lang.Long value) {
		...
		* not null: true<br>
		 ...
		 */
		public java.lang.Long getTransfer_id() {
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 transfer_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 ...
		 * 外部キー名 transfer_tags_transfer_id_fkey<br>
		 * 項目名 transfer_id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transfer_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transfer_tags.this.getRuntimeId(), transfer_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transfer_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transfer_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transfer_tags() {}
	 ...
	 */
	public transfer_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transfer_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transfer_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfer_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfer_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final transfer_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transfer_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transfer_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_tags UNION_ALL(SelectStatement select) {
	 ...
	 */
	public transfer_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transfer_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfer_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfer_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public transfer_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.transfer_id = builder$.buildColumn(
				this,
				sqlassist.bb.transfer_tags.transfer_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transfer_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transfer_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transfer_tags.bb$tags$transfer_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transfers.ExtAssist<T, Many<sqlassist.bb.transfer_tags.Row, M>> $transfers() {
			return new sqlassist.bb.transfers.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transfer_tags.bb$transfers$transfer_tags_transfer_id_fkey);
		}
