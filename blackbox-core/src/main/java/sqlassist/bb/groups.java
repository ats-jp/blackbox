...
public class groups
	 ...
	 * not null: true<br>
	 */
	@Column(name = "parent_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "親グループID", defaultValue = "null", ordinalPosition = 5, notNull = true)
