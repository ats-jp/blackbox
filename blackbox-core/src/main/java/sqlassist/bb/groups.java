...
public class groups
	...
	RightTable<groups.OnRightAssist> {
	...
	/**
	 * name: tree_revision<br>
	 * remarks: グループ階層リビジョン番号<br>
	 * グループの階層構造が変更されるたびに増加するリビジョン番号<br>
	 * 実態は組織ごとの連番だが、シーケンスの最大値が大きいので簡略化のため全体に対する連番とする<br>
	...
	public static class Row extends java.lang.Object
		 ...
		 * @param value java.lang.Long
		 */
		public void setTree_revision(java.lang.Long value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("tree_revision").getType());
			data$.setValue("tree_revision", valueExtractor.extractAsBinder(value));
		}
		 ...
		 * @return java.lang.Long
		 */
		public java.lang.Long getTree_revision() {
			Binder binder = data$.getValue("tree_revision");
			return (java.lang.Long) binder.getValue();
		}
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$groups_created_by_fkey() {
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$groups_updated_by_fkey() {
			return sqlassist.bb.users.row(
	 ...
	 */
	public groups(SelectContext context) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> groups CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups EXCEPT_ALL(SelectStatement select) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.groups.id);
			...
			this.tree_revision = builder$.buildColumn(this, sqlassist.bb.groups.tree_revision);
			this.props = builder$.buildColumn(this, sqlassist.bb.groups.props);
			this.tags = builder$.buildColumn(this, sqlassist.bb.groups.tags);
			this.active = builder$.buildColumn(this, sqlassist.bb.groups.active);
			this.created_at = builder$.buildColumn(this, sqlassist.bb.groups.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb.groups.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb.groups.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb.groups.updated_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.groups.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.groups.bb$groups$groups_parent_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.orgs.ExtAssist<T, Many<sqlassist.bb.groups.Row, M>> $orgs() {
			return new sqlassist.bb.orgs.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.groups.bb$orgs$groups_org_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.groups.Row, M>> $users$groups_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.groups.bb$users$groups_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.groups.Row, M>> $users$groups_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.groups.bb$users$groups_updated_by_fkey);
		}
	}
