...
public class transient_nodes
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_nodes_created_by_fkey() {
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_nodes_updated_by_fkey() {
			return sqlassist.bb.users.row(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_nodes EXCEPT_ALL(SelectStatement select) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_nodes.Row, M>> $users$transient_nodes_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_nodes.bb$users$transient_nodes_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_nodes.Row, M>> $users$transient_nodes_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
