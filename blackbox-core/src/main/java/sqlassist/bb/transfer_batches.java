 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transfer_batches<br>
 * type: TABLE<br>
 * remarks: 移動伝票一括登録<br>
 */
@Table(name = "transfer_batches", schema = "bb", type = "TABLE", remarks = "移動伝票一括登録")
@PrimaryKey(name = "transfer_batches_pkey", columns = { "id" })
public class transfer_batches
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transfer_batches.Iterator, transfer_batches.Row>,
	RightTable<transfer_batches.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transfer_batches";
	...
	/**
	 * name: transfer_batches_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "transfer_batches_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$transfer_batches_created_by_fkey = "transfer_batches_created_by_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transfer_batches_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$transfer_batches_created_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transfer_batches.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transfer_batches.this.getRuntimeId(), transfer_batches.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transfer_batches of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transfer_batches(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public transfer_batches(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transfer_batches(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transfer_batches selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfer_batches groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfer_batches orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public transfer_batches SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transfer_batches WHERE(
	 ...
	 */
	@SafeVarargs
	public final transfer_batches HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_batches> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_batches> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_batches> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_batches> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transfer_batches CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_batches ORDER_BY(
	 ...
	 */
	public transfer_batches setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transfer_batches setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfer_batches and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfer_batches or(Criteria criteria) {
	 ...
	 */
	@Override
	public transfer_batches accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_batches resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transfer_batches.id);
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb.transfer_batches.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb.transfer_batches.created_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transfer_batches.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transfer_batches.bb$users$transfer_batches_created_by_fkey);
		}
