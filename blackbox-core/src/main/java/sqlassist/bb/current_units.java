 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: current_units<br>
 * type: TABLE<br>
 * remarks: 現時点管理対象<br>
 * 管理対象の現在数を保持<br>
 */
@Table(name = "current_units", schema = "bb", type = "TABLE", remarks = "現時点管理対象\n管理対象の現在数を保持")
@PrimaryKey(name = "current_units_pkey", columns = { "id" })
public class current_units
	...
	SelectStatement,
	SQLDecorators,
	Query<current_units.Iterator, current_units.Row>,
	RightTable<current_units.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "current_units";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "total", type = 2, typeName = "numeric", size = 131089, hasDecimalDigits = true, decimalDigits = 0, remarks = "現時点の総数", defaultValue = "null", ordinalPosition = 3, notNull = true)
	...
	/**
	 * name: current_units_snapshot_id_fkey<br>
	 * references: snapshots<br>
	 * columns: snapshot_id
	 */
	@ForeignKey(name = "current_units_snapshot_id_fkey", references = "bb.snapshots", columns = { "snapshot_id" }, refColumns = { "id" })
	public static final String bb$snapshots$current_units_snapshot_id_fkey = "current_units_snapshot_id_fkey";

	/**
	 * name: current_units_id_fkey<br>
	 * references: units<br>
	 * columns: id
	 */
	@ForeignKey(name = "current_units_id_fkey", references = "bb.units", columns = { "id" }, refColumns = { "id" })
	public static final String bb$units$current_units_id_fkey = "current_units_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 外部キー名 current_units_snapshot_id_fkey<br>
		 * 項目名 snapshot_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.snapshots.Row $snapshots() {
			return sqlassist.bb.snapshots.row(
				data$.getDataObject(bb$snapshots$current_units_snapshot_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 units<br>
		 * 外部キー名 current_units_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), current_units.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				current_units.this.getRuntimeId(),
				current_units.this);
		}
	 ...
	 */
	public current_units(SelectContext context) {
	 ...
	 * @return this
	 */
	public current_units selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public current_units groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public current_units orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final current_units WHERE(
	 ...
	 */
	@SafeVarargs
	public final current_units HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_units> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_units> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_units> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, current_units> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_units EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public current_units setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public current_units setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public current_units and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public current_units or(Criteria criteria) {
	 ...
	 */
	@Override
	public current_units accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public current_units resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.snapshots.ExtAssist<T, Many<sqlassist.bb.current_units.Row, M>> $snapshots() {
			return new sqlassist.bb.snapshots.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.current_units.bb$snapshots$current_units_snapshot_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.units.ExtAssist<T, Many<sqlassist.bb.current_units.Row, M>> $units() {
