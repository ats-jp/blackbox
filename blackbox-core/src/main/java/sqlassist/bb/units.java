 ...
 * type: TABLE<br>
 * remarks: 管理対象<br>
 * Blackboxで数量管理する管理対象の最小単位<br>
 */
@Table(name = "units", schema = "bb", type = "TABLE", remarks = "管理対象\nBlackboxで数量管理する管理対象の最小単位")
@PrimaryKey(name = "units_pkey", columns = { "id" })
public class units
	...
	SelectStatement,
	SQLDecorators,
	Query<units.Iterator, units.Row>,
	RightTable<units.OnRightAssist> {
	 ...
	 * columns: created_by
	 */
	@ForeignKey(name = "units_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$units_created_by_fkey = "units_created_by_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 users<br>
		 * 外部キー名 units_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$units_created_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), units.this);
		}
	 ...
	 */
	public units(SelectContext context) {
	 ...
	 * @return this
	 */
	public units selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public units groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public units orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, units> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, units> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, units> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, units> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> units CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public units UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public units UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public units INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public units INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public units EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public units EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public units setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public units setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public units and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public units or(Criteria criteria) {
	 ...
	 */
	@Override
	public units accept(SQLDecorator... decorators) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.units.id);
			this.group_id = builder$.buildColumn(this, sqlassist.bb.units.group_id);
			this.created_at = builder$.buildColumn(this, sqlassist.bb.units.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb.units.created_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.units.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.units.bb$users$units_created_by_fkey);
		}
