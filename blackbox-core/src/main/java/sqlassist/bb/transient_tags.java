...
public class transient_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.transient_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_tags.transient_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transient_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_tags.bb$tags$transient_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transients.ExtAssist<T, Many<sqlassist.bb.transient_tags.Row, M>> $transients() {
			return new sqlassist.bb.transients.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_tags.bb$transients$transient_tags_transient_id_fkey);
		}
