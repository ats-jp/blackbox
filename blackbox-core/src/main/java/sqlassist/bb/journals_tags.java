...
public class journals_tags
	 ...
	 */
	public journals_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.journals_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb.journals_tags.tag_id);
		}
