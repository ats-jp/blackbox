 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: journals_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "journals_tags", schema = "bb", type = "TABLE", remarks = "")
public class journals_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<journals_tags.Iterator, journals_tags.Row>,
	RightTable<journals_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "journals_tags";
	...
	/**
	 * name: journals_tags_id_fkey<br>
	 * references: journals<br>
	 * columns: id
	 */
	@ForeignKey(name = "journals_tags_id_fkey", references = "bb.journals", columns = { "id" }, refColumns = { "id" })
	public static final String bb$journals$journals_tags_id_fkey = "journals_tags_id_fkey";

	/**
	 * name: journals_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "journals_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$journals_tags_tag_id_fkey = "journals_tags_tag_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 外部キー名 journals_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.journals.Row $journals() {
			return sqlassist.bb.journals.row(
				data$.getDataObject(bb$journals$journals_tags_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 journals_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$journals_tags_tag_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), journals_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				journals_tags.this.getRuntimeId(),
				journals_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static journals_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new journals_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public journals_tags() {}
	 ...
	 */
	public journals_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private journals_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public journals_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public journals_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public journals_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final journals_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final journals_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journals_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journals_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journals_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journals_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> journals_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journals_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public journals_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public journals_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public journals_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public journals_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public journals_tags accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public journals_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.journals_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.journals_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.journals.ExtAssist<T, Many<sqlassist.bb.journals_tags.Row, M>> $journals() {
			return new sqlassist.bb.journals.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.journals_tags.bb$journals$journals_tags_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.journals_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.journals_tags.bb$tags$journals_tags_tag_id_fkey);
		}
