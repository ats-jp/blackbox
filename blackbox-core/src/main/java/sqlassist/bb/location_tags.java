 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: location_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "location_tags", schema = "bb", type = "TABLE", remarks = "")
public class location_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<location_tags.Iterator, location_tags.Row>,
	RightTable<location_tags.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "location_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 外部キー名 location_tags_location_id_fkey<br>
		 * 項目名 location_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 location_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), location_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, location_tags.this.getRuntimeId(), location_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static location_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new location_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public location_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private location_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public location_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public location_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public location_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public location_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public location_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final location_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final location_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, location_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, location_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, location_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, location_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> location_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public location_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public location_tags UNION_ALL(SelectStatement select) {
	 ...
	 */
	public location_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public location_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public location_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public location_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public location_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public location_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.location_id = builder$.buildColumn(
				this,
				sqlassist.bb.location_tags.location_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.location_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.locations.ExtAssist<T, Many<sqlassist.bb.location_tags.Row, M>> $locations() {
			return new sqlassist.bb.locations.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.location_tags.bb$locations$location_tags_location_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.location_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.location_tags.bb$tags$location_tags_tag_id_fkey);
		}
