 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_transfers_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transient_transfers_tags", schema = "bb", type = "TABLE", remarks = "")
public class transient_transfers_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transient_transfers_tags.Iterator, transient_transfers_tags.Row>,
	RightTable<transient_transfers_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_transfers_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "tag_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 2, notNull = true)
	public static final String tag_id = "tag_id";

	/**
	 * name: transient_transfers_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "transient_transfers_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$transient_transfers_tags_tag_id_fkey = "transient_transfers_tags_tag_id_fkey";

	/**
	 * name: transient_transfers_tags_id_fkey<br>
	 * references: transient_transfers<br>
	 * columns: id
	 */
	@ForeignKey(name = "transient_transfers_tags_id_fkey", references = "bb.transient_transfers", columns = { "id" }, refColumns = { "id" })
	public static final String bb$transient_transfers$transient_transfers_tags_id_fkey = "transient_transfers_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 * @param value java.lang.Long
		 */
		public void setTag_id(java.lang.Long value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("tag_id").getType());
			data$.setValue("tag_id", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		 * @return java.lang.Long
		 */
		public java.lang.Long getTag_id() {
			Binder binder = data$.getValue("tag_id");
			return (java.lang.Long) binder.getValue();
		}
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 transient_transfers_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$transient_transfers_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 transient_transfers<br>
		 * 外部キー名 transient_transfers_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.transient_transfers.Row $transient_transfers() {
			return sqlassist.bb.transient_transfers.row(
				data$.getDataObject(bb$transient_transfers$transient_transfers_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_transfers_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transient_transfers_tags.this.getRuntimeId(), transient_transfers_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_transfers_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_transfers_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_transfers_tags() {}
	 ...
	 */
	public transient_transfers_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_transfers_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_transfers_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_transfers_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_transfers_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public transient_transfers_tags SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_transfers_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_transfers_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfers_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfers_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfers_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfers_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transient_transfers_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers_tags ORDER_BY(
	 ...
	 */
	public transient_transfers_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_transfers_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_transfers_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_transfers_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public transient_transfers_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	 ...
	 * @return このインスタンス
	 */
	public transient_transfers_tags reset() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		final transient_transfers_tags table$;
		 ...
		 * 項目名 tag_id
		 */
		public final T tag_id;

		private Assist(
			transient_transfers_tags table$,
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transient_transfers_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfers_tags.bb$tags$transient_transfers_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transient_transfers.ExtAssist<T, Many<sqlassist.bb.transient_transfers_tags.Row, M>> $transient_transfers() {
			return new sqlassist.bb.transient_transfers.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfers_tags.bb$transient_transfers$transient_transfers_tags_id_fkey);
		}
