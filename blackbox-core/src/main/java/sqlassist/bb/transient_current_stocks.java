...
public class transient_current_stocks
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_current_stocks_created_by_fkey() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_current_stocks.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_current_stocks.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_current_stocks.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.stocks.ExtAssist<T, Many<sqlassist.bb.transient_current_stocks.Row, M>> $stocks() {
			return new sqlassist.bb.stocks.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_current_stocks.bb$stocks$transient_current_stocks_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_current_stocks.Row, M>> $users$transient_current_stocks_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_current_stocks.bb$users$transient_current_stocks_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_current_stocks.Row, M>> $users$transient_current_stocks_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
