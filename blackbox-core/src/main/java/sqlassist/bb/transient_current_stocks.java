...
public class transient_current_stocks
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_current_stocks EXCEPT_ALL(SelectStatement select) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.infinity = builder$.buildColumn(
				this,
				sqlassist.bb.transient_current_stocks.infinity);
