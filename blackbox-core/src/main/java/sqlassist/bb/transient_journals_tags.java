...
public class transient_journals_tags
	 ...
	 */
	public transient_journals_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.transient_journals_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb.transient_journals_tags.tag_id);
		}
