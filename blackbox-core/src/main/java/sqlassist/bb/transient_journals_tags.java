 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_journals_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transient_journals_tags", schema = "bb", type = "TABLE", remarks = "")
public class transient_journals_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transient_journals_tags.Iterator, transient_journals_tags.Row>,
	RightTable<transient_journals_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_journals_tags";
	...
	/**
	 * name: transient_journals_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "transient_journals_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$transient_journals_tags_tag_id_fkey = "transient_journals_tags_tag_id_fkey";

	/**
	 * name: transient_journals_tags_id_fkey<br>
	 * references: transient_journals<br>
	 * columns: id
	 */
	@ForeignKey(name = "transient_journals_tags_id_fkey", references = "bb.transient_journals", columns = { "id" }, refColumns = { "id" })
	public static final String bb$transient_journals$transient_journals_tags_id_fkey = "transient_journals_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 transient_journals_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$transient_journals_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 transient_journals<br>
		 * 外部キー名 transient_journals_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.transient_journals.Row $transient_journals() {
			return sqlassist.bb.transient_journals.row(
				data$.getDataObject(bb$transient_journals$transient_journals_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_journals_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				transient_journals_tags.this.getRuntimeId(),
				transient_journals_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_journals_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_journals_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_journals_tags() {}
	 ...
	 */
	public transient_journals_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_journals_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_journals_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_journals_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_journals_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public transient_journals_tags SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_journals_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_journals_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_journals_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_journals_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_journals_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_journals_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transient_journals_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_journals_tags ORDER_BY(
	 ...
	 */
	public transient_journals_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_journals_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_journals_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_journals_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public transient_journals_tags accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	 ...
	 * @return このインスタンス
	 */
	public transient_journals_tags reset() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		final transient_journals_tags table$;
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_journals_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_journals_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transient_journals_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_journals_tags.bb$tags$transient_journals_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transient_journals.ExtAssist<T, Many<sqlassist.bb.transient_journals_tags.Row, M>> $transient_journals() {
			return new sqlassist.bb.transient_journals.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_journals_tags.bb$transient_journals$transient_journals_tags_id_fkey);
		}
