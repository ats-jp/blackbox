 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transfers_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transfers_tags", schema = "bb", type = "TABLE", remarks = "")
public class transfers_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transfers_tags.Iterator, transfers_tags.Row>,
	RightTable<transfers_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transfers_tags";
	...
	/**
	 * name: transfers_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "transfers_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$transfers_tags_tag_id_fkey = "transfers_tags_tag_id_fkey";

	/**
	 * name: transfers_tags_id_fkey<br>
	 * references: transfers<br>
	 * columns: id
	 */
	@ForeignKey(name = "transfers_tags_id_fkey", references = "bb.transfers", columns = { "id" }, refColumns = { "id" })
	public static final String bb$transfers$transfers_tags_id_fkey = "transfers_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 transfers_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$transfers_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 transfers<br>
		 * 外部キー名 transfers_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.transfers.Row $transfers() {
			return sqlassist.bb.transfers.row(
				data$.getDataObject(bb$transfers$transfers_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transfers_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transfers_tags.this.getRuntimeId(), transfers_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transfers_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transfers_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transfers_tags() {}
	 ...
	 */
	public transfers_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transfers_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transfers_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfers_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfers_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transfers_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transfers_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfers_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfers_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfers_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfers_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transfers_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfers_tags ORDER_BY(
	 ...
	 */
	public transfers_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transfers_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfers_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfers_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public transfers_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transfers_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transfers_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transfers_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transfers_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transfers_tags.bb$tags$transfers_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transfers.ExtAssist<T, Many<sqlassist.bb.transfers_tags.Row, M>> $transfers() {
			return new sqlassist.bb.transfers.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transfers_tags.bb$transfers$transfers_tags_id_fkey);
		}
