 ...
 * remarks: <br>
 */
@Table(name = "owners_tags", schema = "bb", type = "TABLE", remarks = "")
public class owners_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<owners_tags.Iterator, owners_tags.Row>,
	RightTable<owners_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "owners_tags";
	 ...
	 * columns: id
	 */
	@ForeignKey(name = "owners_tags_id_fkey", references = "bb.owners", columns = { "id" }, refColumns = { "id" })
	public static final String bb$owners$owners_tags_id_fkey = "owners_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 */
		public sqlassist.bb.owners.Row $owners() {
			return sqlassist.bb.owners.row(
				data$.getDataObject(bb$owners$owners_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), owners_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, owners_tags.this.getRuntimeId(), owners_tags.this);
		}
	 ...
	 * @return this
	 */
	public owners_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public owners_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public owners_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final owners_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final owners_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> owners_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public owners_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public owners_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public owners_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public owners_tags or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public owners_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.owners_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.owners_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.owners.ExtAssist<T, Many<sqlassist.bb.owners_tags.Row, M>> $owners() {
			return new sqlassist.bb.owners.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.owners_tags.bb$owners$owners_tags_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.owners_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.owners_tags.bb$tags$owners_tags_tag_id_fkey);
		}
