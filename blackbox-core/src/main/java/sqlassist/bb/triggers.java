...
public class triggers
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.triggers.id);
			this.group_id = builder$.buildColumn(
				this,
				sqlassist.bb.triggers.group_id);
			this.fqcn = builder$.buildColumn(
				this,
				sqlassist.bb.triggers.fqcn);
			this.name = builder$.buildColumn(
				this,
				sqlassist.bb.triggers.name);
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb.triggers.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb.triggers.created_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.triggers.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.triggers.bb$groups$triggers_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.triggers.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.triggers.bb$users$triggers_created_by_fkey);
		}
