...
@PrimaryKey(name = "closed_stocks_pkey", columns = { "id" })
public class closed_stocks
	...
	RightTable<closed_stocks.OnRightAssist> {
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				closed_stocks.this.getRuntimeId(),
				closed_stocks.this);
		}
	 ...
	 * @return this
	 */
	public closed_stocks selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public closed_stocks groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public closed_stocks orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_stocks> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_stocks> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_stocks> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_stocks> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> closed_stocks CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_stocks INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_stocks INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_stocks EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_stocks EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public closed_stocks setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public closed_stocks setOrderByClause(OrderByClause clause) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.closings.ExtAssist<T, Many<sqlassist.bb.closed_stocks.Row, M>> $closings() {
			return new sqlassist.bb.closings.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.closed_stocks.bb$closings$closed_stocks_closing_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.stocks.ExtAssist<T, Many<sqlassist.bb.closed_stocks.Row, M>> $stocks() {
			return new sqlassist.bb.stocks.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.closed_stocks.bb$stocks$closed_stocks_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.closed_stocks.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.closed_stocks.bb$users$closed_stocks_updated_by_fkey);
		}
