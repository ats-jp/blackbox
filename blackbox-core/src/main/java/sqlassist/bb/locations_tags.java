 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: locations_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "locations_tags", schema = "bb", type = "TABLE", remarks = "")
public class locations_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<locations_tags.Iterator, locations_tags.Row>,
	RightTable<locations_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "locations_tags";
	 ...
	 * columns: id
	 */
	@ForeignKey(name = "locations_tags_id_fkey", references = "bb.locations", columns = { "id" }, refColumns = { "id" })
	public static final String bb$locations$locations_tags_id_fkey = "locations_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 */
		public sqlassist.bb.locations.Row $locations() {
			return sqlassist.bb.locations.row(
				data$.getDataObject(bb$locations$locations_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), locations_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, locations_tags.this.getRuntimeId(), locations_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static locations_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new locations_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public locations_tags() {}
	 ...
	 */
	public locations_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private locations_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public locations_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public locations_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public locations_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final locations_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final locations_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locations_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locations_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locations_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, locations_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> locations_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations_tags ORDER_BY(
	 ...
	 */
	public locations_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public locations_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public locations_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public locations_tags or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public locations_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.locations_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.locations_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.locations.ExtAssist<T, Many<sqlassist.bb.locations_tags.Row, M>> $locations() {
			return new sqlassist.bb.locations.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.locations_tags.bb$locations$locations_tags_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.locations_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.locations_tags.bb$tags$locations_tags_tag_id_fkey);
		}
