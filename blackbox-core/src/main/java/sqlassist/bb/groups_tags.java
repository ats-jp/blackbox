 ...
 * remarks: <br>
 */
@Table(name = "groups_tags", schema = "bb", type = "TABLE", remarks = "")
public class groups_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<groups_tags.Iterator, groups_tags.Row>,
	RightTable<groups_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "groups_tags";
	...
	/**
	 * name: groups_tags_id_fkey<br>
	 * references: groups<br>
	 * columns: id
	 */
	@ForeignKey(name = "groups_tags_id_fkey", references = "bb.groups", columns = { "id" }, refColumns = { "id" })
	public static final String bb$groups$groups_tags_id_fkey = "groups_tags_id_fkey";

	/**
	 * name: groups_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "groups_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$groups_tags_tag_id_fkey = "groups_tags_tag_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 groups_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups() {
			return sqlassist.bb.groups.row(
				data$.getDataObject(bb$groups$groups_tags_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 groups_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$groups_tags_tag_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), groups_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, groups_tags.this.getRuntimeId(), groups_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static groups_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new groups_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public groups_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private groups_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public groups_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public groups_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public groups_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final groups_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final groups_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, groups_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> groups_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public groups_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public groups_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public groups_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public groups_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public groups_tags or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public groups_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.groups_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.groups_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.groups_tags.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.groups_tags.bb$groups$groups_tags_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.groups_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.groups_tags.bb$tags$groups_tags_tag_id_fkey);
		}
