...
public class groups_tags
	 ...
	 */
	public groups_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.groups_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb.groups_tags.tag_id);
		}
