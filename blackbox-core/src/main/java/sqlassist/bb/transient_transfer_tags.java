 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_transfer_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transient_transfer_tags", schema = "bb", type = "TABLE", remarks = "")
public class transient_transfer_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transient_transfer_tags.Iterator, transient_transfer_tags.Row>,
	RightTable<transient_transfer_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_transfer_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "transient_transfer_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	/**
	 * name: transient_transfer_tags_tag_id_fkey<br>
	 * reference: tags<br>
	 * columns: tag_id
	 */
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 transient_transfer_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 ...
		 * 外部キー名 transient_transfer_tags_transient_transfer_id_fkey<br>
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_transfer_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transient_transfer_tags.this.getRuntimeId(), transient_transfer_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_transfer_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_transfer_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_transfer_tags() {}
	 ...
	 */
	public transient_transfer_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_transfer_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_transfer_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_transfer_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_transfer_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public transient_transfer_tags SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfer_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfer_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfer_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_transfer_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_transfer_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfer_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfer_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfer_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_transfer_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transient_transfer_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfer_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfer_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfer_tags ORDER_BY(
	 ...
	 */
	public transient_transfer_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_transfer_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_transfer_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_transfer_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public transient_transfer_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	 ...
	 * @return このインスタンス
	 */
	public transient_transfer_tags reset() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		final transient_transfer_tags table$;
		...
		private Assist(
			...
			this.transient_transfer_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfer_tags.transient_transfer_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfer_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transient_transfer_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfer_tags.bb$tags$transient_transfer_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transient_transfers.ExtAssist<T, Many<sqlassist.bb.transient_transfer_tags.Row, M>> $transient_transfers() {
			return new sqlassist.bb.transient_transfers.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfer_tags.bb$transient_transfers$transient_transfer_tags_transient_transfer_id_fkey);
		}
