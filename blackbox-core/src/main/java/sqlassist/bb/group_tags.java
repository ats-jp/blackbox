 ...
 * remarks: <br>
 */
@Table(name = "group_tags", schema = "bb", type = "TABLE", remarks = "")
public class group_tags
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "group_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "group_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	public static final String bb$groups$group_tags_group_id_fkey = "group_tags_group_id_fkey";
	...
	public static final String bb$tags$group_tags_tag_id_fkey = "group_tags_tag_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 group_tags_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups() {
			return sqlassist.bb.groups.row(
				data$.getDataObject(bb$groups$group_tags_group_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 group_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$group_tags_tag_id_fkey));
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static group_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new group_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public group_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private group_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public group_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public group_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public group_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public group_tags UNION_ALL(SelectStatement select) {
	 ...
	 */
	public group_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public group_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public group_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public group_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public group_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public group_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public group_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public group_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.group_id = builder$.buildColumn(
				this,
				sqlassist.bb.group_tags.group_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.group_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.group_tags.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.group_tags.bb$groups$group_tags_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.group_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.group_tags.bb$tags$group_tags_tag_id_fkey);
		}
