...
public class current_stocks
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public current_stocks EXCEPT_ALL(SelectStatement select) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.unlimited = builder$.buildColumn(
				this,
				sqlassist.bb.current_stocks.unlimited);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.stocks.ExtAssist<T, Many<sqlassist.bb.current_stocks.Row, M>> $stocks() {
