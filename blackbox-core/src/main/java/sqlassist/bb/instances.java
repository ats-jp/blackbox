 ...
 * name: instances<br>
 * type: TABLE<br>
 * remarks: Blackbox運用インスタンス<br>
 * org単位でデータを移行する際の発生元を表す<br>
 */
@Table(name = "instances", schema = "bb", type = "TABLE", remarks = "Blackbox運用インスタンス\norg単位でデータを移行する際の発生元を表す")
@PrimaryKey(name = "instances_pkey", columns = { "id" })
public class instances
	...
	SelectStatement,
	SQLDecorators,
	Query<instances.Iterator, instances.Row>,
	RightTable<instances.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "description", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "補足事項", defaultValue = "null", ordinalPosition = 4, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		public void setPrincipal(java.lang.Boolean value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("principal").getType());
			data$.setValue("principal", valueExtractor.extractAsBinder(value));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), instances.this);
		}
	 ...
	 */
	public instances(SelectContext context) {
	 ...
	 * @return this
	 */
	public instances selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public instances groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public instances orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, instances> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, instances> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, instances> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, instances> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public instances EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public instances setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public instances setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public instances and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public instances or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public instances resetDecorators() {
		decorators$.clear();
		return this;
	}
