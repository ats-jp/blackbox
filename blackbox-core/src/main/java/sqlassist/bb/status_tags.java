 ...
 * remarks: <br>
 */
@Table(name = "status_tags", schema = "bb", type = "TABLE", remarks = "")
public class status_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<status_tags.Iterator, status_tags.Row>,
	RightTable<status_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "status_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "status_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 外部キー名 status_tags_status_id_fkey<br>
		 * 項目名 status_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 status_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), status_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, status_tags.this.getRuntimeId(), status_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static status_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new status_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public status_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private status_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public status_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public status_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public status_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public status_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public status_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final status_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final status_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, status_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, status_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, status_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, status_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> status_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public status_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public status_tags UNION_ALL(SelectStatement select) {
	 ...
	 */
	public status_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public status_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public status_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public status_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public status_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public status_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.status_id = builder$.buildColumn(
				this,
				sqlassist.bb.status_tags.status_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.status_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.statuses.ExtAssist<T, Many<sqlassist.bb.status_tags.Row, M>> $statuses() {
			return new sqlassist.bb.statuses.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.status_tags.bb$statuses$status_tags_status_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.status_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.status_tags.bb$tags$status_tags_tag_id_fkey);
		}
