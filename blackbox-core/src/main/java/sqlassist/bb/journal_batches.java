 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: journal_batches<br>
 * type: TABLE<br>
 * remarks: 伝票一括登録<br>
 */
@Table(name = "journal_batches", schema = "bb", type = "TABLE", remarks = "伝票一括登録")
@PrimaryKey(name = "journal_batches_pkey", columns = { "id" })
public class journal_batches
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<journal_batches.Iterator, journal_batches.Row>,
	RightTable<journal_batches.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "journal_batches";
	...
	/**
	 * name: journal_batches_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "journal_batches_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$journal_batches_created_by_fkey = "journal_batches_created_by_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 users<br>
		 * 外部キー名 journal_batches_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$journal_batches_created_by_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), journal_batches.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				journal_batches.this.getRuntimeId(),
				journal_batches.this);
		}
	 ...
	 */
	public journal_batches(SelectContext context) {
	 ...
	 * @return this
	 */
	public journal_batches selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public journal_batches groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public journal_batches orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final journal_batches WHERE(
	 ...
	 */
	@SafeVarargs
	public final journal_batches HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journal_batches> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journal_batches> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journal_batches> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, journal_batches> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> journal_batches CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public journal_batches ORDER_BY(
	 ...
	 */
	public journal_batches setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public journal_batches setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public journal_batches and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public journal_batches or(Criteria criteria) {
	 ...
	 */
	@Override
	public journal_batches accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public journal_batches resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.journal_batches.id);
			this.created_at = builder$.buildColumn(this, sqlassist.bb.journal_batches.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb.journal_batches.created_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.journal_batches.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.journal_batches.bb$users$journal_batches_created_by_fkey);
		}
	}
