...
public class users_tags
	 ...
	 */
	public users_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.users_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb.users_tags.tag_id);
		}
