 ...
 * name: executors<br>
 * type: TABLE<br>
 * remarks: journal登録executor<br>
 */
@Table(name = "executors", schema = "bb", type = "TABLE", remarks = "journal登録executor")
@PrimaryKey(name = "executors_pkey", columns = { "id" })
public class executors
	...
	SelectStatement,
	SQLDecorators,
	Query<executors.Iterator, executors.Row>,
	RightTable<executors.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "executors";
	...
	/**
	 * name: executors_org_id_fkey<br>
	 * references: orgs<br>
	 * columns: org_id
	 */
	@ForeignKey(name = "executors_org_id_fkey", references = "bb.orgs", columns = { "org_id" }, refColumns = { "id" })
	public static final String bb$orgs$executors_org_id_fkey = "executors_org_id_fkey";

	/**
	 * name: executors_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "executors_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$executors_created_by_fkey = "executors_created_by_fkey";

	/**
	 * name: executors_updated_by_fkey<br>
	 * references: users<br>
	 * columns: updated_by
	 */
	@ForeignKey(name = "executors_updated_by_fkey", references = "bb.users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String bb$users$executors_updated_by_fkey = "executors_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 orgs<br>
		 * 外部キー名 executors_org_id_fkey<br>
		 * 項目名 org_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.orgs.Row $orgs() {
			return sqlassist.bb.orgs.row(
				data$.getDataObject(bb$orgs$executors_org_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 executors_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$executors_created_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$executors_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 executors_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$executors_updated_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$executors_updated_by_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), executors.this);
		}
	 ...
	 */
	public executors(SelectContext context) {
	 ...
	 * @return this
	 */
	public executors selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public executors groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public executors orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> executors CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public executors setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public executors setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public executors and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public executors or(Criteria criteria) {
	 ...
	 */
	@Override
	public executors accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public executors resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.executors.id);
			this.org_id = builder$.buildColumn(this, sqlassist.bb.executors.org_id);
			this.seq = builder$.buildColumn(this, sqlassist.bb.executors.seq);
			this.name = builder$.buildColumn(this, sqlassist.bb.executors.name);
			this.description = builder$.buildColumn(this, sqlassist.bb.executors.description);
			this.revision = builder$.buildColumn(this, sqlassist.bb.executors.revision);
			this.props = builder$.buildColumn(this, sqlassist.bb.executors.props);
			this.active = builder$.buildColumn(this, sqlassist.bb.executors.active);
			this.created_at = builder$.buildColumn(this, sqlassist.bb.executors.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb.executors.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb.executors.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb.executors.updated_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.orgs.ExtAssist<T, Many<sqlassist.bb.executors.Row, M>> $orgs() {
			return new sqlassist.bb.orgs.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.executors.bb$orgs$executors_org_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.executors.Row, M>> $users$executors_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.executors.bb$users$executors_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.executors.Row, M>> $users$executors_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.executors.bb$users$executors_updated_by_fkey);
		}
	}
