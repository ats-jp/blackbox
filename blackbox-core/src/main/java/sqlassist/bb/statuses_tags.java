 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: statuses_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "statuses_tags", schema = "bb", type = "TABLE", remarks = "")
public class statuses_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<statuses_tags.Iterator, statuses_tags.Row>,
	RightTable<statuses_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "statuses_tags";
	 ...
	 * columns: id
	 */
	@ForeignKey(name = "statuses_tags_id_fkey", references = "bb.statuses", columns = { "id" }, refColumns = { "id" })
	public static final String bb$statuses$statuses_tags_id_fkey = "statuses_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 */
		public sqlassist.bb.statuses.Row $statuses() {
			return sqlassist.bb.statuses.row(
				data$.getDataObject(bb$statuses$statuses_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), statuses_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static statuses_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new statuses_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public statuses_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private statuses_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public statuses_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public statuses_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public statuses_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final statuses_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final statuses_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, statuses_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, statuses_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, statuses_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, statuses_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> statuses_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public statuses_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public statuses_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public statuses_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public statuses_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public statuses_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public statuses_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public statuses_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.statuses_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.statuses_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.statuses.ExtAssist<T, Many<sqlassist.bb.statuses_tags.Row, M>> $statuses() {
			return new sqlassist.bb.statuses.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.statuses_tags.bb$statuses$statuses_tags_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.statuses_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.statuses_tags.bb$tags$statuses_tags_tag_id_fkey);
		}
