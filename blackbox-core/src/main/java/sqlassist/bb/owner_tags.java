 ...
 * remarks: <br>
 */
@Table(name = "owner_tags", schema = "bb", type = "TABLE", remarks = "")
public class owner_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<owner_tags.Iterator, owner_tags.Row>,
	RightTable<owner_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "owner_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "owner_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	/**
	 * name: owner_tags_owner_id_fkey<br>
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 owners<br>
		 * 外部キー名 owner_tags_owner_id_fkey<br>
		 * 項目名 owner_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 owner_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
	 ...
	 * @return このクラスのインスタンス
	 */
	public static owner_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new owner_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public owner_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private owner_tags(Class<?> using, String id) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owner_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owner_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final owner_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owner_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owner_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owner_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owner_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> owner_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owner_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owner_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public owner_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public owner_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public owner_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public owner_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public owner_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public owner_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.owner_id = builder$.buildColumn(
				this,
				sqlassist.bb.owner_tags.owner_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.owner_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.owners.ExtAssist<T, Many<sqlassist.bb.owner_tags.Row, M>> $owners() {
			return new sqlassist.bb.owners.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.owner_tags.bb$owners$owner_tags_owner_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.owner_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.owner_tags.bb$tags$owner_tags_tag_id_fkey);
		}
