...
public class users
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$users_created_by_fkey() {
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$users_updated_by_fkey() {
			return sqlassist.bb.users.row(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public users INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public users INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public users EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public users EXCEPT_ALL(SelectStatement select) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.users.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.users.bb$groups$users_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.users.Row, M>> $users$users_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.users.bb$users$users_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.users.Row, M>> $users$users_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
