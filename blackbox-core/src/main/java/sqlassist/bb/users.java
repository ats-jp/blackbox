...
public class users
	 ...
	 */
	public users(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.code = builder$.buildColumn(this, sqlassist.bb.users.code);
