...
public class items
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$items_created_by_fkey() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public items INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public items INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public items EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public items EXCEPT_ALL(SelectStatement select) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.items.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.items.bb$groups$items_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.items.Row, M>> $users$items_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.items.bb$users$items_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.items.Row, M>> $users$items_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.items.bb$users$items_updated_by_fkey);
		}
