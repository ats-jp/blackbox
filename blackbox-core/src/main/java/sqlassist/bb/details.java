 ...
 * 出ノードと入ノードを束ねる<br>
 */
@Table(name = "details", schema = "bb", type = "TABLE", remarks = "伝票明細\n伝票とノードの関連付けテーブル\n出ノードと入ノードを束ねる")
@PrimaryKey(name = "details_pkey", columns = { "id" })
public class details
	...
	SelectStatement,
	SQLDecorators,
	Query<details.Iterator, details.Row>,
	RightTable<details.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "journal_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "伝票ID", defaultValue = "null", ordinalPosition = 2, notNull = true)
	 ...
	 * columns: journal_id
	 */
	@ForeignKey(name = "details_journal_id_fkey", references = "bb.journals", columns = { "journal_id" }, refColumns = { "id" })
	public static final String bb$journals$details_journal_id_fkey = "details_journal_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		...
		public void setJournal_id(java.util.UUID value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("journal_id").getType());
			data$.setValue("journal_id", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		 ...
		 * 外部キー名 details_journal_id_fkey<br>
		 * 項目名 journal_id
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), details.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static details of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new details(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public details(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private details(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public details selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public details groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public details orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, details> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, details> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, details> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, details> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> details CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public details EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public details setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public details setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public details and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public details or(Criteria criteria) {
	 ...
	 */
	@Override
	public details accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public details resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.journals.ExtAssist<T, Many<sqlassist.bb.details.Row, M>> $journals() {
