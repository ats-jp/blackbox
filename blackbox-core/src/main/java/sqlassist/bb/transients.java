 ...
 * remarks: 一時作業<br>
 */
@Table(name = "transients", schema = "bb", type = "TABLE", remarks = "一時作業")
@PrimaryKey(name = "transients_pkey", columns = { "id" })
public class transients
	...
	SelectStatement,
	SQLDecorators,
	Query<transients.Iterator, transients.Row>,
	RightTable<transients.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transients";
	...
	/**
	 * name: seq_in_group<br>
	 * remarks: グループ内連番<br>
	 * type: int8(19)<br>
	 * not null: true<br>
	 */
	@Column(name = "seq_in_group", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "グループ内連番", defaultValue = "null", ordinalPosition = 3, notNull = true)
	public static final String seq_in_group = "seq_in_group";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "seq_in_user", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ユーザー内連番", defaultValue = "null", ordinalPosition = 5, notNull = true)
	...
	/**
	 * name: transients_group_id_fkey<br>
	...
	public static class Row extends java.lang.Object
		 ...
		 */
		public void setSeq_in_group(java.lang.Long value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("seq_in_group").getType());
			data$.setValue("seq_in_group", valueExtractor.extractAsBinder(value));
		}
		 ...
		 */
		public java.lang.Long getSeq_in_group() {
			Binder binder = data$.getValue("seq_in_group");
		 ...
		 * @param value java.lang.Long
		 */
		public void setSeq_in_user(java.lang.Long value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("seq_in_user").getType());
			data$.setValue("seq_in_user", valueExtractor.extractAsBinder(value));
		}
		 ...
		 * @return java.lang.Long
		 */
		public java.lang.Long getSeq_in_user() {
			Binder binder = data$.getValue("seq_in_user");
			return (java.lang.Long) binder.getValue();
		}
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 transients_group_id_fkey<br>
		 * 項目名 group_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transients_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transients_created_by_fkey() {
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transients_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transients_updated_by_fkey() {
			return sqlassist.bb.users.row(
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transients_user_id_fkey<br>
		 * 項目名 user_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transients_user_id_fkey() {
			return sqlassist.bb.users.row(
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transients.this);
		}
	 ...
	 */
	public transients(SelectContext context) {
	 ...
	 * @return this
	 */
	public transients selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transients groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transients orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final transients HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transients CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public transients setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transients setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transients and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transients or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public transients resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transients resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transients resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.transients.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transients.bb$groups$transients_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transients.Row, M>> $users$transients_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transients.bb$users$transients_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transients.Row, M>> $users$transients_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transients.bb$users$transients_updated_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transients.Row, M>> $users$transients_user_id_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
