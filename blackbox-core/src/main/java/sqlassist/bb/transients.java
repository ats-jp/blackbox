...
public class transients
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transients.this.getRuntimeId(), transients.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transients of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transients(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public transients(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transients(Class<?> using, String id) {
