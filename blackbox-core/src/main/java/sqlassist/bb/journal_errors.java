...
public class journal_errors
	 ...
	 * @return このクラスのインスタンス
	 */
	public static journal_errors of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new journal_errors(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	...
	private journal_errors(Class<?> using, String id) {
