 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_snapshots<br>
 * type: TABLE<br>
 * remarks: 一時作業移動ノード状態<br>
 */
@Table(name = "transient_snapshots", schema = "bb", type = "TABLE", remarks = "一時作業移動ノード状態")
@PrimaryKey(name = "transient_snapshots_pkey", columns = { "id" })
public class transient_snapshots
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_snapshots";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 transient_nodes<br>
		 * 外部キー名 transient_snapshots_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.transient_nodes.Row $transient_nodes() {
			return sqlassist.bb.transient_nodes.row(
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_snapshots_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_snapshots_created_by_fkey() {
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_snapshots_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_snapshots_updated_by_fkey() {
			return sqlassist.bb.users.row(
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_snapshots of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_snapshots(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_snapshots() {}
	 ...
	 */
	public transient_snapshots(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transient_snapshots(Class<?> using, String id) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_snapshots EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_snapshots and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_snapshots or(Criteria criteria) {
	 ...
	 */
	@Override
	public transient_snapshots apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots resetDecorators() {
		decorators$.clear();
		return this;
	}
	 ...
	 * @return このインスタンス
	 */
	public transient_snapshots reset() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_snapshots.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_snapshots.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_snapshots.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_snapshots.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.transient_nodes.ExtAssist<T, Many<sqlassist.bb.transient_snapshots.Row, M>> $transient_nodes() {
			return new sqlassist.bb.transient_nodes.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_snapshots.bb$transient_nodes$transient_snapshots_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_snapshots.Row, M>> $users$transient_snapshots_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_snapshots.bb$users$transient_snapshots_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_snapshots.Row, M>> $users$transient_snapshots_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_snapshots.bb$users$transient_snapshots_updated_by_fkey);
		}
