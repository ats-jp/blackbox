...
public class tags
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "gen_random_uuid()", ordinalPosition = 1, notNull = true)
