 ...
 * remarks: <br>
 */
@Table(name = "tags", schema = "bb", type = "TABLE", remarks = "")
@PrimaryKey(name = "tags_pkey", columns = { "id" })
public class tags
	...
	SelectStatement,
	SQLDecorators,
	Query<tags.Iterator, tags.Row>,
	RightTable<tags.OnRightAssist> {
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "nextval('bb.tags_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "tag", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 2, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		...
		public void setTag(java.lang.String value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("tag").getType());
			data$.setValue("tag", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		...
		public java.lang.String getTag() {
			Binder binder = data$.getValue("tag");
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, tags.this.getRuntimeId(), tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public tags or(Criteria criteria) {
