 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: executors_groups<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "executors_groups", schema = "bb", type = "TABLE", remarks = "")
public class executors_groups
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<executors_groups.Iterator, executors_groups.Row>,
	RightTable<executors_groups.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "executors_groups";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "group_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 2, notNull = true)
	 ...
	 * columns: id
	 */
	@ForeignKey(name = "executors_groups_id_fkey", references = "bb.executors", columns = { "id" }, refColumns = { "id" })
	public static final String bb$executors$executors_groups_id_fkey = "executors_groups_id_fkey";

	/**
	 * name: executors_groups_group_id_fkey<br>
	...
	public static class Row extends java.lang.Object
		 ...
		 */
		public sqlassist.bb.executors.Row $executors() {
			return sqlassist.bb.executors.row(
				data$.getDataObject(bb$executors$executors_groups_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 executors_groups_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), executors_groups.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				executors_groups.this.getRuntimeId(),
				executors_groups.this);
		}
	 ...
	 */
	public executors_groups(SelectContext context) {
	 ...
	 * @return this
	 */
	public executors_groups selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public executors_groups groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public executors_groups orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public executors_groups SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final executors_groups WHERE(
	 ...
	 */
	@SafeVarargs
	public final executors_groups HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors_groups> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors_groups> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors_groups> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, executors_groups> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> executors_groups CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public executors_groups ORDER_BY(
	 ...
	 */
	public executors_groups setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public executors_groups setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public executors_groups and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public executors_groups or(Criteria criteria) {
	 ...
	 */
	@Override
	public executors_groups accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public executors_groups resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 * 外部キー名 executors_groups_id_fkey<br>
		 * 項目名 id
		 * @return executors relationship
		 */
		public sqlassist.bb.executors.ExtAssist<T, Many<sqlassist.bb.executors_groups.Row, M>> $executors() {
			return new sqlassist.bb.executors.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.executors_groups.bb$executors$executors_groups_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.executors_groups.Row, M>> $groups() {
