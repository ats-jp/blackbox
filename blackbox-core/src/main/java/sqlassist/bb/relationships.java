 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: relationships<br>
 * type: TABLE<br>
 * remarks: グループ親子関係<br>
 * 親IDが指定されたら子も対象とするための補助テーブル<br>
 */
@Table(name = "relationships", schema = "bb", type = "TABLE", remarks = "グループ親子関係\n親IDが指定されたら子も対象とするための補助テーブル")
@PrimaryKey(name = "relationships_pkey", columns = { "id" })
public class relationships
	...
	SelectStatement,
	SQLDecorators,
	Query<relationships.Iterator, relationships.Row>,
	RightTable<relationships.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "relationships";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "nextval('bb.relationships_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "cascade_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "カスケード削除用ID\n自身が依存する親のIDを持っておき、親が削除されたときに連鎖的にすべて削除するための項目", defaultValue = "null", ordinalPosition = 4, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		...
		public void setChild_id(java.lang.Long value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("child_id").getType());
			data$.setValue("child_id", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 relationships_child_id_fkey<br>
		 * 項目名 child_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups$relationships_child_id_fkey() {
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 relationships_parent_id_fkey<br>
		 * 項目名 parent_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups$relationships_parent_id_fkey() {
			return sqlassist.bb.groups.row(
		...
		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 relationships<br>
		 * 外部キー名 relationships_cascade_id_fkey<br>
		 * 項目名 cascade_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.relationships.Row $relationships() {
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), relationships.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, relationships.this.getRuntimeId(), relationships.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static relationships of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new relationships(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public relationships(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private relationships(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public relationships selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public relationships groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public relationships orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final relationships WHERE(
	 ...
	 */
	@SafeVarargs
	public final relationships HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, relationships> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, relationships> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, relationships> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, relationships> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> relationships CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public relationships EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public relationships setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public relationships setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public relationships and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public relationships or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public relationships resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.relationships.Row, M>> $groups$relationships_child_id_fkey() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.relationships.bb$groups$relationships_child_id_fkey);
		}
		 ...
		 * @return groups relationship
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.relationships.Row, M>> $groups$relationships_parent_id_fkey() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.relationships.bb$groups$relationships_parent_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.relationships.ExtAssist<T, Many<sqlassist.bb.relationships.Row, M>> $relationships() {
			return new sqlassist.bb.relationships.ExtAssist<>(
				builder$,
				this,
