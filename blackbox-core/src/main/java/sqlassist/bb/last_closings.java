 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: last_closings<br>
 * type: TABLE<br>
 * remarks: グループ最終締め情報<br>
 */
@Table(name = "last_closings", schema = "bb", type = "TABLE", remarks = "グループ最終締め情報")
@PrimaryKey(name = "last_closings_pkey", columns = { "id" })
public class last_closings
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<last_closings.Iterator, last_closings.Row>,
	RightTable<last_closings.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "last_closings";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		...
		public void setClosed_at(java.sql.Timestamp value) {
			...
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("closed_at").getType());
			data$.setValue("closed_at", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		...
		public java.sql.Timestamp getClosed_at() {
			Binder binder = data$.getValue("closed_at");
		 ...
		 * 外部キー名 last_closings_closing_id_fkey<br>
		 * 項目名 closing_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 last_closings_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), last_closings.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, last_closings.this.getRuntimeId(), last_closings.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static last_closings of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new last_closings(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public last_closings() {}
	...
	private last_closings(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public last_closings selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public last_closings groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public last_closings orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final last_closings WHERE(
	 ...
	 */
	@SafeVarargs
	public final last_closings HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, last_closings> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, last_closings> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, last_closings> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, last_closings> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> last_closings CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public last_closings EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public last_closings setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public last_closings setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public last_closings and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public last_closings or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public last_closings resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.closings.ExtAssist<T, Many<sqlassist.bb.last_closings.Row, M>> $closings() {
			return new sqlassist.bb.closings.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.last_closings.bb$closings$last_closings_closing_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.last_closings.Row, M>> $groups() {
