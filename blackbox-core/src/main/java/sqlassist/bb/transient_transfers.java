...
public class transient_transfers
	 ...
	 * not null: true<br>
	 */
	@Column(name = "group_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "グループID", defaultValue = "null", ordinalPosition = 3, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_transfers_created_by_fkey() {
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_transfers_updated_by_fkey() {
			return sqlassist.bb.users.row(
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				transient_transfers.this.getRuntimeId(),
				transient_transfers.this);
		}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_transfers EXCEPT_ALL(SelectStatement select) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.id);
			this.transient_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.transient_id);
			this.group_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.group_id);
			...
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_transfers.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.transient_transfers.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfers.bb$groups$transient_transfers_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transients.ExtAssist<T, Many<sqlassist.bb.transient_transfers.Row, M>> $transients() {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_transfers.Row, M>> $users$transient_transfers_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfers.bb$users$transient_transfers_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_transfers.Row, M>> $users$transient_transfers_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_transfers.bb$users$transient_transfers_updated_by_fkey);
		}
