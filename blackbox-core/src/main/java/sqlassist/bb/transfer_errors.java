 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transfer_errors<br>
 * type: TABLE<br>
 * remarks: transfer登録時に発生したエラー<br>
 */
@Table(name = "transfer_errors", schema = "bb", type = "TABLE", remarks = "transfer登録時に発生したエラー")
public class transfer_errors
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transfer_errors.Iterator, transfer_errors.Row>,
	RightTable<transfer_errors.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transfer_errors";
	 ...
	 * columns: user_id
	 */
	@ForeignKey(name = "transfer_errors_user_id_fkey", references = "bb.users", columns = { "user_id" }, refColumns = { "id" })
	public static final String bb$users$transfer_errors_user_id_fkey = "transfer_errors_user_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transfer_errors_user_id_fkey<br>
		 * 項目名 user_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$transfer_errors_user_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transfer_errors.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transfer_errors.this.getRuntimeId(), transfer_errors.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transfer_errors of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transfer_errors(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transfer_errors() {}
	 ...
	 */
	public transfer_errors(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transfer_errors(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transfer_errors selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfer_errors groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transfer_errors orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transfer_errors WHERE(
	 ...
	 */
	@SafeVarargs
	public final transfer_errors HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_errors> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_errors> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_errors> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transfer_errors> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transfer_errors CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transfer_errors ORDER_BY(
	 ...
	 */
	public transfer_errors setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transfer_errors setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfer_errors and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transfer_errors or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transfer_errors resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transfer_errors.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transfer_errors.bb$users$transfer_errors_user_id_fkey);
		}
