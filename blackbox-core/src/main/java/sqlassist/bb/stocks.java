...
public class stocks
	 ...
	 * @return この {@link SelectStatement}
	 */
	public stocks INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public stocks INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public stocks EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public stocks EXCEPT_ALL(SelectStatement select) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb.stocks.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.stocks.bb$groups$stocks_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.items.ExtAssist<T, Many<sqlassist.bb.stocks.Row, M>> $items() {
			return new sqlassist.bb.items.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.stocks.bb$items$stocks_item_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.locations.ExtAssist<T, Many<sqlassist.bb.stocks.Row, M>> $locations() {
			return new sqlassist.bb.locations.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.stocks.bb$locations$stocks_location_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.owners.ExtAssist<T, Many<sqlassist.bb.stocks.Row, M>> $owners() {
			return new sqlassist.bb.owners.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.stocks.bb$owners$stocks_owner_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.statuses.ExtAssist<T, Many<sqlassist.bb.stocks.Row, M>> $statuses() {
			return new sqlassist.bb.statuses.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.stocks.bb$statuses$stocks_status_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.stocks.Row, M>> $users() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.stocks.bb$users$stocks_created_by_fkey);
		}
