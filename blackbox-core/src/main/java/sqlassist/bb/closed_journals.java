 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: closed_journals<br>
 * type: TABLE<br>
 * remarks: 締め済み伝票<br>
 */
@Table(name = "closed_journals", schema = "bb", type = "TABLE", remarks = "締め済み伝票")
@PrimaryKey(name = "closed_journals_pkey", columns = { "id" })
public class closed_journals
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<closed_journals.Iterator, closed_journals.Row>,
	RightTable<closed_journals.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "closed_journals";
	 ...
	 * not null: false<br>
	 */
	@Column(name = "closing_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "締めID", defaultValue = "null", ordinalPosition = 2, notNull = false)
	public static final String closing_id = "closing_id";

	/**
	 * name: closed_journals_closing_id_fkey<br>
	 * references: closings<br>
	 * columns: closing_id
	 */
	@ForeignKey(name = "closed_journals_closing_id_fkey", references = "bb.closings", columns = { "closing_id" }, refColumns = { "id" })
	public static final String bb$closings$closed_journals_closing_id_fkey = "closed_journals_closing_id_fkey";

	/**
	 * name: closed_journals_id_fkey<br>
	 * references: journals<br>
	 * columns: id
	 */
	@ForeignKey(name = "closed_journals_id_fkey", references = "bb.journals", columns = { "id" }, refColumns = { "id" })
	public static final String bb$journals$closed_journals_id_fkey = "closed_journals_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * @return java.util.UUID
		 */
		public Optional<java.util.UUID> getClosing_id() {
		 ...
		 * 外部キー名 closed_journals_closing_id_fkey<br>
		 * 項目名 closing_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.closings.Row $closings() {
			return sqlassist.bb.closings.row(
				data$.getDataObject(bb$closings$closed_journals_closing_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 journals<br>
		 * 外部キー名 closed_journals_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.journals.Row $journals() {
			return sqlassist.bb.journals.row(
				data$.getDataObject(bb$journals$closed_journals_id_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), closed_journals.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				closed_journals.this.getRuntimeId(),
				closed_journals.this);
		}
	 ...
	 */
	public closed_journals(SelectContext context) {
	 ...
	 * @return this
	 */
	public closed_journals selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public closed_journals groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public closed_journals orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final closed_journals WHERE(
	 ...
	 */
	@SafeVarargs
	public final closed_journals HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_journals> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_journals> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_journals> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, closed_journals> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> closed_journals CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public closed_journals ORDER_BY(
	 ...
	 */
	public closed_journals setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public closed_journals setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public closed_journals and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public closed_journals or(Criteria criteria) {
	 ...
	 */
	@Override
	public closed_journals accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public closed_journals resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.closed_journals.id);
			this.closing_id = builder$.buildColumn(this, sqlassist.bb.closed_journals.closing_id);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.closings.ExtAssist<T, Many<sqlassist.bb.closed_journals.Row, M>> $closings() {
			return new sqlassist.bb.closings.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.closed_journals.bb$closings$closed_journals_closing_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.journals.ExtAssist<T, Many<sqlassist.bb.closed_journals.Row, M>> $journals() {
			return new sqlassist.bb.journals.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.closed_journals.bb$journals$closed_journals_id_fkey);
		}
	}
