 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transients_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "transients_tags", schema = "bb", type = "TABLE", remarks = "")
public class transients_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transients_tags.Iterator, transients_tags.Row>,
	RightTable<transients_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transients_tags";
	...
	/**
	 * name: transients_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "transients_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$transients_tags_tag_id_fkey = "transients_tags_tag_id_fkey";

	/**
	 * name: transients_tags_id_fkey<br>
	 * references: transients<br>
	 * columns: id
	 */
	@ForeignKey(name = "transients_tags_id_fkey", references = "bb.transients", columns = { "id" }, refColumns = { "id" })
	public static final String bb$transients$transients_tags_id_fkey = "transients_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 transients_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$transients_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 transients<br>
		 * 外部キー名 transients_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.transients.Row $transients() {
			return sqlassist.bb.transients.row(
				data$.getDataObject(bb$transients$transients_tags_id_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transients_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, transients_tags.this.getRuntimeId(), transients_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transients_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transients_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transients_tags() {}
	 ...
	 */
	public transients_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private transients_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transients_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transients_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transients_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transients_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final transients_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transients_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> transients_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transients_tags ORDER_BY(
	 ...
	 */
	public transients_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transients_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transients_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transients_tags or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transients_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transients_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.transients_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.transients_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transients_tags.bb$tags$transients_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.transients.ExtAssist<T, Many<sqlassist.bb.transients_tags.Row, M>> $transients() {
			return new sqlassist.bb.transients.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transients_tags.bb$transients$transients_tags_id_fkey);
		}
