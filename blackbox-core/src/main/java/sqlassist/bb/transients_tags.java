...
public class transients_tags
	 ...
	 */
	public transients_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb.transients_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb.transients_tags.tag_id);
		}
