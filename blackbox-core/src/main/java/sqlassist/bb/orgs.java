...
public class orgs
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$orgs_created_by_fkey() {
		 ...
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$orgs_updated_by_fkey() {
			return sqlassist.bb.users.row(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public orgs INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public orgs INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public orgs EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public orgs EXCEPT_ALL(SelectStatement select) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.orgs.Row, M>> $users$orgs_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.orgs.bb$users$orgs_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.orgs.Row, M>> $users$orgs_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
