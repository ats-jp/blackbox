...
public class transient_bundles
	 ...
	 * not null: true<br>
	 */
	@Column(name = "transient_transfer_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "一時作業移動伝票ID", defaultValue = "null", ordinalPosition = 2, notNull = true)
	...
	public static final String bb$transient_transfers$transient_bundles_transient_transfer_id_fkey = "transient_bundles_transient_transfer_id_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 * @param value java.util.UUID
		 */
		public void setTransient_transfer_id(java.util.UUID value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
		...
		* not null: true<br>
		...
		public sqlassist.bb.transient_transfers.Row $transient_transfers() {
			return sqlassist.bb.transient_transfers.row(
				data$.getDataObject(bb$transient_transfers$transient_bundles_transient_transfer_id_fkey));
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				transient_bundles.this.getRuntimeId(),
				transient_bundles.this);
		}
	 ...
	 * @return this
	 */
	public transient_bundles selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_bundles groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_bundles orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_bundles INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_bundles INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_bundles EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_bundles EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public transient_bundles setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_bundles setOrderByClause(OrderByClause clause) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_bundles.id);
			...
			this.revision = builder$.buildColumn(
				this,
				sqlassist.bb.transient_bundles.revision);
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_bundles.created_at);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.transient_transfers.ExtAssist<T, Many<sqlassist.bb.transient_bundles.Row, M>> $transient_transfers() {
			return new sqlassist.bb.transient_transfers.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_bundles.bb$transient_transfers$transient_bundles_transient_transfer_id_fkey);
		}
