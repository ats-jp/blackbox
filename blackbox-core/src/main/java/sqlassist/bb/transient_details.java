 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb<br>
 * name: transient_details<br>
 * type: TABLE<br>
 * remarks: 一時作業伝票明細<br>
 */
@Table(name = "transient_details", schema = "bb", type = "TABLE", remarks = "一時作業伝票明細")
@PrimaryKey(name = "transient_details_pkey", columns = { "id" })
public class transient_details
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<transient_details.Iterator, transient_details.Row>,
	RightTable<transient_details.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "transient_details";
	...
	/**
	 * name: transient_journal_id<br>
	 * remarks: 一時作業伝票ID<br>
	 * type: uuid(2147483647)<br>
	 * not null: true<br>
	 */
	@Column(name = "transient_journal_id", type = 1111, typeName = "uuid", size = 2147483647, hasDecimalDigits = true, decimalDigits = 0, remarks = "一時作業伝票ID", defaultValue = "null", ordinalPosition = 2, notNull = true)
	public static final String transient_journal_id = "transient_journal_id";
	...
	/**
	 * name: transient_details_transient_journal_id_fkey<br>
	 * references: transient_journals<br>
	 * columns: transient_journal_id
	 */
	@ForeignKey(name = "transient_details_transient_journal_id_fkey", references = "bb.transient_journals", columns = { "transient_journal_id" }, refColumns = { "id" })
	public static final String bb$transient_journals$transient_details_transient_journal_id_fkey = "transient_details_transient_journal_id_fkey";

	/**
	 * name: transient_details_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "transient_details_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$transient_details_created_by_fkey = "transient_details_created_by_fkey";

	/**
	 * name: transient_details_updated_by_fkey<br>
	 * references: users<br>
	 * columns: updated_by
	 */
	@ForeignKey(name = "transient_details_updated_by_fkey", references = "bb.users", columns = { "updated_by" }, refColumns = { "id" })
	public static final String bb$users$transient_details_updated_by_fkey = "transient_details_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 * @param value java.util.UUID
		 */
		public void setTransient_journal_id(java.util.UUID value) {
			Objects.requireNonNull(value);
			ValueExtractor valueExtractor = ContextManager.get(ValueExtractorsConfigure.class)
				.getValueExtractors()
				.selectValueExtractor(
					rowRel$.getColumn("transient_journal_id").getType());
			data$.setValue("transient_journal_id", valueExtractor.extractAsBinder(value));
		}
		...
		* not null: true<br>
		 * @return java.util.UUID
		 */
		public java.util.UUID getTransient_journal_id() {
			Binder binder = data$.getValue("transient_journal_id");
			return (java.util.UUID) binder.getValue();
		}
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 transient_journals<br>
		 * 外部キー名 transient_details_transient_journal_id_fkey<br>
		 * 項目名 transient_journal_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.transient_journals.Row $transient_journals() {
			return sqlassist.bb.transient_journals.row(
				data$.getDataObject(bb$transient_journals$transient_details_transient_journal_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_details_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_details_created_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$transient_details_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 transient_details_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$transient_details_updated_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$transient_details_updated_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), transient_details.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				transient_details.this.getRuntimeId(),
				transient_details.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static transient_details of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new transient_details(getUsing(new Throwable().getStackTrace()[1]), id);
	}

	/**
	 * 空のインスタンスを生成します。
	 */
	public transient_details() {}
	...
	private transient_details(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public transient_details selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_details groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public transient_details orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 */
	public transient_details SELECT(
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details SELECT_COUNT() {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details GROUP_BY(
	 ...
	 */
	@SafeVarargs
	public final transient_details WHERE(
	 ...
	 */
	@SafeVarargs
	public final transient_details HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_details> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_details> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_details> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, transient_details> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details EXCEPT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public transient_details ORDER_BY(
	 ...
	 */
	public transient_details setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public transient_details setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_details and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public transient_details or(Criteria criteria) {
	 ...
	 */
	@Override
	public transient_details accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public transient_details resetDecorators() {
		decorators$.clear();
		return this;
	}
	 ...
	 * @return このインスタンス
	 */
	public transient_details reset() {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		 ...
		 * 項目名 transient_journal_id
		 */
		public final T transient_journal_id;
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.id);
			this.transient_journal_id = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.transient_journal_id);
			this.seq_in_journal = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.seq_in_journal);
			this.extension = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.extension);
			this.revision = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.revision);
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				sqlassist.bb.transient_details.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 * 外部キー名 transient_details_transient_journal_id_fkey<br>
		 * 項目名 transient_journal_id
		 * @return transient_journals relationship
		 */
		public sqlassist.bb.transient_journals.ExtAssist<T, Many<sqlassist.bb.transient_details.Row, M>> $transient_journals() {
			return new sqlassist.bb.transient_journals.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_details.bb$transient_journals$transient_details_transient_journal_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_details.Row, M>> $users$transient_details_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_details.bb$users$transient_details_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb.transient_details.Row, M>> $users$transient_details_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.transient_details.bb$users$transient_details_updated_by_fkey);
		}
