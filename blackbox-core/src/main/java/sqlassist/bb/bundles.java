 ...
 * remarks: 移動伝票明細<br>
 * 移動の単体<br>
 * 移動伝票とノードの関連付けテーブル<br>
 * 出庫ノードと入庫ノードを束ねる<br>
 */
@Table(name = "bundles", schema = "bb", type = "TABLE", remarks = "移動伝票明細\n移動の単体\n移動伝票とノードの関連付けテーブル\n出庫ノードと入庫ノードを束ねる")
@PrimaryKey(name = "bundles_pkey", columns = { "id" })
public class bundles
	...
	SelectStatement,
	SQLDecorators,
	Query<bundles.Iterator, bundles.Row>,
	RightTable<bundles.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "bundles";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "id", type = -5, typeName = "bigserial", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "ID", defaultValue = "nextval('bb.bundles_id_seq'::regclass)", ordinalPosition = 1, notNull = true)
	 ...
	 * not null: true<br>
	 */
	@Column(name = "transfer_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = true, decimalDigits = 0, remarks = "移動伝票ID", defaultValue = "null", ordinalPosition = 2, notNull = true)
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 外部キー名 bundles_transfer_id_fkey<br>
		 * 項目名 transfer_id
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), bundles.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, bundles.this.getRuntimeId(), bundles.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static bundles of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new bundles(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public bundles(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private bundles(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public bundles selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public bundles groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public bundles orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, bundles> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, bundles> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, bundles> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, bundles> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> bundles CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public bundles EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public bundles setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public bundles setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public bundles and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public bundles or(Criteria criteria) {
	 ...
	 * @return このインスタンス
	 */
	public bundles resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb.bundles.id);
			this.transfer_id = builder$.buildColumn(
				this,
				sqlassist.bb.bundles.transfer_id);
			this.extension = builder$.buildColumn(
				this,
				sqlassist.bb.bundles.extension);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.transfers.ExtAssist<T, Many<sqlassist.bb.bundles.Row, M>> $transfers() {
			return new sqlassist.bb.transfers.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.bundles.bb$transfers$bundles_transfer_id_fkey);
		}
