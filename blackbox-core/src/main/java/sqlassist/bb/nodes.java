...
public class nodes
	 ...
	 */
	public nodes(SelectContext context) {
	 ...
	 * @return this
	 */
	public nodes selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public nodes groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public nodes orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public nodes INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public nodes INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public nodes EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public nodes EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public nodes setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public nodes setOrderByClause(OrderByClause clause) {
