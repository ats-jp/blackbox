 ...
 * remarks: <br>
 */
@Table(name = "item_tags", schema = "bb", type = "TABLE", remarks = "")
public class item_tags
	...
	SelectStatement,
	SQLDecorators,
	Query<item_tags.Iterator, item_tags.Row>,
	RightTable<item_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "item_tags";
	 ...
	 * not null: true<br>
	 */
	@Column(name = "item_id", type = -5, typeName = "int8", size = 19, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "null", ordinalPosition = 1, notNull = true)
	...
	/**
	 * name: item_tags_item_id_fkey<br>
	 * references: items<br>
	 * columns: item_id
	 */
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 items<br>
		 * 外部キー名 item_tags_item_id_fkey<br>
		 * 項目名 item_id
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 item_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), item_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super($TABLE, item_tags.this.getRuntimeId(), item_tags.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static item_tags of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new item_tags(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public item_tags(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private item_tags(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public item_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public item_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public item_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public item_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, item_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, item_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, item_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, item_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> item_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public item_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public item_tags UNION_ALL(SelectStatement select) {
	 ...
	 */
	public item_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public item_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public item_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public item_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public item_tags apply(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public item_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.item_id = builder$.buildColumn(
				this,
				sqlassist.bb.item_tags.item_id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb.item_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.items.ExtAssist<T, Many<sqlassist.bb.item_tags.Row, M>> $items() {
			return new sqlassist.bb.items.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.item_tags.bb$items$item_tags_item_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb.item_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb.item_tags.bb$tags$item_tags_tag_id_fkey);
		}
