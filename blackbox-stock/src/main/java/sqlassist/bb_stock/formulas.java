 ...
 * type: TABLE<br>
 * remarks: 変換式<br>
 * 事前に定義されたアイテムの変換対応表<br>
 */
@Table(name = "formulas", schema = "bb_stock", type = "TABLE", remarks = "変換式\n事前に定義されたアイテムの変換対応表")
@PrimaryKey(name = "formulas_pkey", columns = { "id" })
public class formulas
	...
	SelectStatement,
	SQLDecorators,
	Query<formulas.Iterator, formulas.Row>,
	RightTable<formulas.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "formulas";
	...
	/**
	 * name: formulas_group_id_fkey<br>
	 * references: groups<br>
	 * columns: group_id
	 */
	@ForeignKey(name = "formulas_group_id_fkey", references = "bb.groups", columns = { "group_id" }, refColumns = { "id" })
	public static final String bb$groups$formulas_group_id_fkey = "formulas_group_id_fkey";

	/**
	 * name: formulas_created_by_fkey<br>
	 * references: users<br>
	 * columns: created_by
	 */
	@ForeignKey(name = "formulas_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" })
	public static final String bb$users$formulas_created_by_fkey = "formulas_created_by_fkey";

	/**
	 * name: formulas_updated_by_fkey<br>
	 * references: users<br>
	 * columns: updated_by
	 */
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 formulas_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups() {
			return sqlassist.bb.groups.row(
				data$.getDataObject(bb$groups$formulas_group_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 formulas_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$formulas_created_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$formulas_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 formulas_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), formulas.this);
		}
	 ...
	 */
	public formulas(SelectContext context) {
	 ...
	 * @return this
	 */
	public formulas selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public formulas groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public formulas orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> formulas CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public formulas setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public formulas setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public formulas and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public formulas or(Criteria criteria) {
	 ...
	 */
	@Override
	public formulas accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public formulas resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.created_at = builder$.buildColumn(this, sqlassist.bb_stock.formulas.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb_stock.formulas.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb_stock.formulas.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb_stock.formulas.updated_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb_stock.formulas.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.formulas.bb$groups$formulas_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_stock.formulas.Row, M>> $users$formulas_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.formulas.bb$users$formulas_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_stock.formulas.Row, M>> $users$formulas_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
