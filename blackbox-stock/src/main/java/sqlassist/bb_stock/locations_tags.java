...
public class locations_tags
	 ...
	 */
	public locations_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_stock.locations_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb_stock.locations_tags.tag_id);
		}
