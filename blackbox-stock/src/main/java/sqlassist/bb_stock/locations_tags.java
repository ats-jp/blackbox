 ...
 * remarks: <br>
 */
@Table(name = "locations_tags", schema = "bb_stock", type = "TABLE", remarks = "")
public class locations_tags
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb_stock.locations_tags.id);
			this.tag_id = builder$.buildColumn(
				this,
				sqlassist.bb_stock.locations_tags.tag_id);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb_stock.locations_tags.Row, M>> $tags() {
