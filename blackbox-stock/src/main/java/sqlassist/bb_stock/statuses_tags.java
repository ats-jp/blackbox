...
public class statuses_tags
	 ...
	 */
	public statuses_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_stock.statuses_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb_stock.statuses_tags.tag_id);
		}
