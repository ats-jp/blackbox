 ...
 */
@Table(name = "stocks", schema = "bb_stock", type = "TABLE", remarks = "在庫\nBlackboxで数量管理する在庫の最小単位")
...
public class stocks
	 ...
	 * columns: location_id
	 */
	@ForeignKey(name = "stocks_location_id_fkey", references = "bb_stock.locations", columns = { "location_id" }, refColumns = { "id" })
	public static final String bb_stock$locations$stocks_location_id_fkey = "stocks_location_id_fkey";
	 ...
	 * columns: owner_id
	 */
	@ForeignKey(name = "stocks_owner_id_fkey", references = "bb_stock.owners", columns = { "owner_id" }, refColumns = { "id" })
	...
	public static class Row extends java.lang.Object
		...
		public sqlassist.bb_stock.locations.Row $locations() {
			return sqlassist.bb_stock.locations.row(
				data$.getDataObject(bb_stock$locations$stocks_location_id_fkey));
		}
		...
		public sqlassist.bb_stock.owners.Row $owners() {
			return sqlassist.bb_stock.owners.row(
				data$.getDataObject(bb_stock$owners$stocks_owner_id_fkey));
		}
	 ...
	 */
	public stocks(SelectContext context) {
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb_stock.locations.ExtAssist<T, Many<sqlassist.bb_stock.stocks.Row, M>> $locations() {
			return new sqlassist.bb_stock.locations.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.stocks.bb_stock$locations$stocks_location_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb_stock.owners.ExtAssist<T, Many<sqlassist.bb_stock.stocks.Row, M>> $owners() {
			return new sqlassist.bb_stock.owners.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.stocks.bb_stock$owners$stocks_owner_id_fkey);
		}
