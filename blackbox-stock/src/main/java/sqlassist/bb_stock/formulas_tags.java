 ...
 * 自動生成されたテーブル操作クラスです。
 * schema: bb_stock<br>
 * name: formulas_tags<br>
 * type: TABLE<br>
 * remarks: <br>
 */
@Table(name = "formulas_tags", schema = "bb_stock", type = "TABLE", remarks = "")
public class formulas_tags
	extends java.lang.Object
	implements
	TableFacade<Row>,
	SelectStatement,
	SQLDecorators,
	Query<formulas_tags.Iterator, formulas_tags.Row>,
	RightTable<formulas_tags.OnRightAssist> {
	 ...
	 * この定数クラスのテーブル名
	 */
	public static final String TABLE = "formulas_tags";
	...
	/**
	 * name: formulas_tags_tag_id_fkey<br>
	 * references: tags<br>
	 * columns: tag_id
	 */
	@ForeignKey(name = "formulas_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" })
	public static final String bb$tags$formulas_tags_tag_id_fkey = "formulas_tags_tag_id_fkey";

	/**
	 * name: formulas_tags_id_fkey<br>
	 * references: formulas<br>
	 * columns: id
	 */
	@ForeignKey(name = "formulas_tags_id_fkey", references = "bb_stock.formulas", columns = { "id" }, refColumns = { "id" })
	public static final String bb_stock$formulas$formulas_tags_id_fkey = "formulas_tags_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * 参照先テーブル名 tags<br>
		 * 外部キー名 formulas_tags_tag_id_fkey<br>
		 * 項目名 tag_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.tags.Row $tags() {
			return sqlassist.bb.tags.row(
				data$.getDataObject(bb$tags$formulas_tags_tag_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 formulas<br>
		 * 外部キー名 formulas_tags_id_fkey<br>
		 * 項目名 id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb_stock.formulas.Row $formulas() {
			return sqlassist.bb_stock.formulas.row(
				data$.getDataObject(bb_stock$formulas$formulas_tags_id_fkey));
		}
	}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), formulas_tags.this);
		}
	...
	private class DMSBehavior extends DataManipulationStatementBehavior<InsertAssist, ListInsertAssist, UpdateAssist, ListUpdateAssist, DMSWhereAssist> {
		...
		public DMSBehavior() {
			super(
				$TABLE,
				relationship$,
				formulas_tags.this.getRuntimeId(),
				formulas_tags.this);
		}
	 ...
	 */
	public formulas_tags(SelectContext context) {
	 ...
	 * @return this
	 */
	public formulas_tags selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public formulas_tags groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public formulas_tags orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags SELECT_DISTINCT(
		SelectOfferFunction<SelectAssist> function) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags SELECT_COUNT() {
	 ...
	 */
	@SafeVarargs
	public final formulas_tags WHERE(
	 ...
	 */
	@SafeVarargs
	public final formulas_tags HAVING(
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas_tags> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas_tags> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas_tags> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, formulas_tags> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> formulas_tags CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public formulas_tags EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public formulas_tags setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public formulas_tags setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public formulas_tags and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public formulas_tags or(Criteria criteria) {
	 ...
	 */
	@Override
	public formulas_tags accept(SQLDecorator... decorators) {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetWhere() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetHaving() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetSelect() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetGroupBy() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetOrderBy() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetUnions() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetJoins() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetInsert() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetUpdate() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetDelete() {
	 ...
	 * @return このインスタンス
	 */
	public formulas_tags resetDecorators() {
		decorators$.clear();
		return this;
	}
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_stock.formulas_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb_stock.formulas_tags.tag_id);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb_stock.formulas_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.formulas_tags.bb$tags$formulas_tags_tag_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb_stock.formulas.ExtAssist<T, Many<sqlassist.bb_stock.formulas_tags.Row, M>> $formulas() {
			return new sqlassist.bb_stock.formulas.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.formulas_tags.bb_stock$formulas$formulas_tags_id_fkey);
		}
	}
