 ...
 * remarks: <br>
 */
@Table(name = "owners_tags", schema = "bb_stock", type = "TABLE", remarks = "")
public class owners_tags
	 ...
	 */
	public owners_tags(SelectContext context) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_stock.owners_tags.id);
			this.tag_id = builder$.buildColumn(this, sqlassist.bb_stock.owners_tags.tag_id);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb_stock.owners.ExtAssist<T, Many<sqlassist.bb_stock.owners_tags.Row, M>> $owners() {
