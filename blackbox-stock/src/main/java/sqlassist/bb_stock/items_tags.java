 ...
 * remarks: <br>
 */
@Table(name = "items_tags", schema = "bb_stock", type = "TABLE", remarks = "")
public class items_tags
	 ...
	 * columns: id
	 */
	@ForeignKey(name = "items_tags_id_fkey", references = "bb_stock.items", columns = { "id" }, refColumns = { "id" })
	public static final String bb_stock$items$items_tags_id_fkey = "items_tags_id_fkey";
	 ...
	 * columns: tag_id
	 */
	@ForeignKey(name = "items_tags_tag_id_fkey", references = "bb.tags", columns = { "tag_id" }, refColumns = { "id" }, pseudo = true)
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb_stock.items.ExtAssist<T, Many<sqlassist.bb_stock.items_tags.Row, M>> $items() {
		 ...
		 */
		public sqlassist.bb.tags.ExtAssist<T, Many<sqlassist.bb_stock.items_tags.Row, M>> $tags() {
			return new sqlassist.bb.tags.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.items_tags.bb$tags$items_tags_tag_id_fkey);
		}
