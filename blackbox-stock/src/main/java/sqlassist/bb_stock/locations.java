 ...
 * アイテムの置き場<br>
 */
@Table(name = "locations", schema = "bb_stock", type = "TABLE", remarks = "置き場\nアイテムの置き場")
...
public class locations
	...
	/**
	 * name: locations_owner_id_fkey<br>
	 * references: owners<br>
	 * columns: owner_id
	 */
	@ForeignKey(name = "locations_owner_id_fkey", references = "bb_stock.owners", columns = { "owner_id" }, refColumns = { "id" })
	public static final String bb_stock$owners$locations_owner_id_fkey = "locations_owner_id_fkey";
	...
	public static class Row extends java.lang.Object
		 ...
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 owners<br>
		 * 外部キー名 locations_owner_id_fkey<br>
		 * 項目名 owner_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb_stock.owners.Row $owners() {
			return sqlassist.bb_stock.owners.row(
				data$.getDataObject(bb_stock$owners$locations_owner_id_fkey));
		}
	}
	 ...
	 */
	public locations(SelectContext context) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public locations EXCEPT_ALL(SelectStatement select) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_stock.locations.id);
			this.group_id = builder$.buildColumn(this, sqlassist.bb_stock.locations.group_id);
			this.seq = builder$.buildColumn(this, sqlassist.bb_stock.locations.seq);
			this.name = builder$.buildColumn(this, sqlassist.bb_stock.locations.name);
			this.code = builder$.buildColumn(this, sqlassist.bb_stock.locations.code);
			this.description = builder$.buildColumn(this, sqlassist.bb_stock.locations.description);
			this.owner_id = builder$.buildColumn(this, sqlassist.bb_stock.locations.owner_id);
			this.revision = builder$.buildColumn(this, sqlassist.bb_stock.locations.revision);
			this.props = builder$.buildColumn(this, sqlassist.bb_stock.locations.props);
			this.tags = builder$.buildColumn(this, sqlassist.bb_stock.locations.tags);
			this.active = builder$.buildColumn(this, sqlassist.bb_stock.locations.active);
			this.created_at = builder$.buildColumn(this, sqlassist.bb_stock.locations.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb_stock.locations.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb_stock.locations.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb_stock.locations.updated_by);
		}
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb_stock.locations.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.locations.bb$groups$locations_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_stock.locations.Row, M>> $users$locations_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.locations.bb$users$locations_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_stock.locations.Row, M>> $users$locations_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.locations.bb$users$locations_updated_by_fkey);
		}
		 ...
		 */
		public sqlassist.bb_stock.owners.ExtAssist<T, Many<sqlassist.bb_stock.locations.Row, M>> $owners() {
			return new sqlassist.bb_stock.owners.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.locations.bb_stock$owners$locations_owner_id_fkey);
		}
	}
