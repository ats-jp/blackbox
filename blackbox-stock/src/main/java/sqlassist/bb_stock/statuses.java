	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.id);
			this.group_id = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.group_id);
			this.name = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.name);
			this.revision = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.revision);
			this.extension = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.extension);
			this.tags = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.tags);
			this.active = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.active);
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				sqlassist.bb_stock.statuses.updated_by);
