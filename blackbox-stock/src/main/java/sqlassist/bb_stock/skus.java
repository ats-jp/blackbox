...
public class skus
	 ...
	 * not null: true<br>
	 */
	@Column(name = "code", type = 12, typeName = "text", size = 2147483647, hasDecimalDigits = false, decimalDigits = 0, remarks = "", defaultValue = "''::text", ordinalPosition = 5, notNull = true)
