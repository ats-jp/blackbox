...
public class owners
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(this, sqlassist.bb_stock.owners.id);
			...
			this.code = builder$.buildColumn(this, sqlassist.bb_stock.owners.code);
			...
			this.active = builder$.buildColumn(this, sqlassist.bb_stock.owners.active);
			this.created_at = builder$.buildColumn(this, sqlassist.bb_stock.owners.created_at);
			this.created_by = builder$.buildColumn(this, sqlassist.bb_stock.owners.created_by);
			this.updated_at = builder$.buildColumn(this, sqlassist.bb_stock.owners.updated_at);
			this.updated_by = builder$.buildColumn(this, sqlassist.bb_stock.owners.updated_by);
		}
