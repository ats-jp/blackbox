 ...
 * アイテムの所有者<br>
 */
@Table(name = "owners", schema = "bb_stock", type = "TABLE", remarks = "所有者\nアイテムの所有者")
@PrimaryKey(name = "owners_pkey", columns = { "id" })
public class owners
	...
	SelectStatement,
	SQLDecorators,
	Query<owners.Iterator, owners.Row>,
	RightTable<owners.OnRightAssist> {
	 ...
	 * columns: group_id
	 */
	@ForeignKey(name = "owners_group_id_fkey", references = "bb.groups", columns = { "group_id" }, refColumns = { "id" }, pseudo = true)
	public static final String bb$groups$owners_group_id_fkey = "owners_group_id_fkey";
	 ...
	 * columns: created_by
	 */
	@ForeignKey(name = "owners_created_by_fkey", references = "bb.users", columns = { "created_by" }, refColumns = { "id" }, pseudo = true)
	public static final String bb$users$owners_created_by_fkey = "owners_created_by_fkey";
	 ...
	 * columns: updated_by
	 */
	@ForeignKey(name = "owners_updated_by_fkey", references = "bb.users", columns = { "updated_by" }, refColumns = { "id" }, pseudo = true)
	public static final String bb$users$owners_updated_by_fkey = "owners_updated_by_fkey";
	...
	public static class Row extends java.lang.Object
		...
		* not null: true<br>
		 ...
		 * 参照先テーブル名 groups<br>
		 * 外部キー名 owners_group_id_fkey<br>
		 * 項目名 group_id
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.groups.Row $groups() {
			return sqlassist.bb.groups.row(
				data$.getDataObject(bb$groups$owners_group_id_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 owners_created_by_fkey<br>
		 * 項目名 created_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$owners_created_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$owners_created_by_fkey));
		}

		/**
		 * このレコードが参照しているレコードの Row を返します。<br>
		 * 参照先テーブル名 users<br>
		 * 外部キー名 owners_updated_by_fkey<br>
		 * 項目名 updated_by
		 * @return 参照しているレコードの Row
		 */
		public sqlassist.bb.users.Row $users$owners_updated_by_fkey() {
			return sqlassist.bb.users.row(
				data$.getDataObject(bb$users$owners_updated_by_fkey));
		}
	...
	private class SelectBehavior extends SelectStatementBehavior<SelectAssist, ListSelectAssist, GroupByAssist, ListGroupByAssist, WhereAssist, HavingAssist, OrderByAssist, ListOrderByAssist, OnLeftAssist> {
		...
		private SelectBehavior() {
			super($TABLE, getRuntimeId(), owners.this);
		}
	 ...
	 * @return このクラスのインスタンス
	 */
	public static owners of(String id) {
		if (id == null || id.equals(""))
			throw new IllegalArgumentException("id が空です");

		return new owners(getUsing(new Throwable().getStackTrace()[1]), id);
	}
	 ...
	 */
	public owners(Optimizer optimizer) {
		selectBehavior().setOptimizer(Objects.requireNonNull(optimizer));
	}

	private owners(Class<?> using, String id) {
	 ...
	 * @return this
	 */
	public owners selectClause(Consumer<ListSelectAssist> consumer) {
	 ...
	 * @return this
	 */
	public owners groupByClause(Consumer<ListGroupByAssist> consumer) {
	 ...
	 * @return this
	 */
	public owners orderByClause(Consumer<ListOrderByAssist> consumer) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners> INNER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners> LEFT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners> RIGHT_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return ON
	 */
	public <R extends OnRightClauseAssist<?>> OnClause<OnLeftAssist, R, owners> FULL_OUTER_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public <R extends OnRightClauseAssist<?>> owners CROSS_JOIN(RightTable<R> right) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners UNION(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners UNION_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners INTERSECT(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners INTERSECT_ALL(SelectStatement select) {
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners EXCEPT(SelectStatement select) {
		selectBehavior().INTERSECT(select);
		return this;
	}
	 ...
	 * @return この {@link SelectStatement}
	 */
	public owners EXCEPT_ALL(SelectStatement select) {
	 ...
	 */
	public owners setGroupByClause(GroupByClause clause) {
	 ...
	 * @throws IllegalStateException 既に ORDER BY 句がセットされている場合
	 */
	public owners setOrderByClause(OrderByClause clause) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public owners and(Criteria criteria) {
	 ...
	 * @return {@link SelectStatement} 自身
	 */
	public owners or(Criteria criteria) {
	...
	public static class Assist<T, M> implements TableFacadeAssist {
		...
		private Assist(
			...
			this.id = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.id);
			this.group_id = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.group_id);
			this.name = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.name);
			this.revision = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.revision);
			this.props = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.props);
			this.tags = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.tags);
			this.active = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.active);
			this.created_at = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.created_at);
			this.created_by = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.created_by);
			this.updated_at = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.updated_at);
			this.updated_by = builder$.buildColumn(
				this,
				sqlassist.bb_stock.owners.updated_by);
	...
	public static class ExtAssist<T, M> extends Assist<T, M> {
		 ...
		 */
		public sqlassist.bb.groups.ExtAssist<T, Many<sqlassist.bb_stock.owners.Row, M>> $groups() {
			return new sqlassist.bb.groups.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.owners.bb$groups$owners_group_id_fkey);
		}
		 ...
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_stock.owners.Row, M>> $users$owners_created_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.owners.bb$users$owners_created_by_fkey);
		}
		 ...
		 * @return users relationship
		 */
		public sqlassist.bb.users.ExtAssist<T, Many<sqlassist.bb_stock.owners.Row, M>> $users$owners_updated_by_fkey() {
			return new sqlassist.bb.users.ExtAssist<>(
				builder$,
				this,
				sqlassist.bb_stock.owners.bb$users$owners_updated_by_fkey);
		}
